...
type: docs
weight: 1120
url: /nodejs/aspose.diagram/headerfooter/
---
...
| [setFooterCenter()](./setfootercenter/) | Contains the text string that appears in the center portion of a document's footer. |
| [setFooterLeft()](./setfooterleft/) | Contains the text string that appears in the left portion of a document's footer. |
| [setFooterMargin()](./setfootermargin/) | Specifies the margin of a document's footer. |
| [setFooterRight()](./setfooterright/) | Contains the text string that appears in the right portion of a document's footer. |
| [setHeaderCenter()](./setheadercenter/) | Contains the text string that appears in the center portion of a document's header. |
| [setHeaderLeft()](./setheaderleft/) | Contains the text string that appears in the left portion of a document's header. |
| [setHeaderMargin()](./setheadermargin/) | Specifies the margin of a document's footer. |
| [setHeaderRight()](./setheaderright/) | Contains the text string that appears in the right portion of a document's header. |
