...
type: docs
weight: 1160
url: /nodejs/aspose.diagram/hyperlink/
---
...
| [getExtraInfo()](./getextrainfo/) | Contains information to be used in resolving a URL, such as the coordinates of an image map. For example, x=41 y=7 would |
| [getFrame()](./getframe/) | Contains the name of a frame to target when Microsoft Visio is open as an active document in a container application. Th |
...
| [getNewWindow()](./getnewwindow/) | Specifies whether Microsoft Visio opens a window in a new location when it follows a hyperlink to open a Web page or ano |
