...
| [Aspose.Diagram.Properties](./aspose.diagram.properties/) | The **Aspose.Diagram.Properties** namespace provides classes to work with custom and built-in properties such as title, keywords, company etc. |
| [Aspose.Diagram.Saving](./aspose.diagram.saving/) | Contains classes for save options. |
| [Aspose.Diagram.Vba](./aspose.diagram.vba/) | The **Aspose.Diagram.Vba** namespace contains classes to access Visual Basic Analysis projects and modules in Visio files. |
