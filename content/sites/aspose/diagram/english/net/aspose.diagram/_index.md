...
| [WalkPreference](./walkpreference/) | Specifies whether an endpoint of a 1-D shape moves to a horizontal or vertical connection point on the shape it is glued to, using dynamic glue, when the shape is moved to an ambiguous position. |
...
| --- | --- |
| [AlignmentValue](./alignmentvalue/) | Specifies the tab alignment. |
| [AlignNameValue](./alignnamevalue/) | Optional int. Specifies whether the master's text in the stencil window is aligned left, right, or center. |
| [ArrowSizeValue](./arrowsizevalue/) | Specifies the size of the arrowhead of the line. |
| [BevelLightingTypeValue](./bevellightingtypevalue/) | Represents a preset light right that can be applied to a shape |
| [BevelMaterialTypeValue](./bevelmaterialtypevalue/) | Describes surface appearance of a shape. |
...
| [ConLineJumpCodeValue](./conlinejumpcodevalue/) | Determines whether a connector jumps when two connectors cross. |
| [ConLineJumpDirXValue](./conlinejumpdirxvalue/) | Determines the line jump direction for line jumps occurring on a horizontal segment of a dynamic connector. |
| [ConLineJumpDirYValue](./conlinejumpdiryvalue/) | Determines the line jump direction for line jumps occurring on a vertical segment of a dynamic connector. |
| [ConLineJumpStyleValue](./conlinejumpstylevalue/) | Determines the line jump style for line jumps on a dynamic connector. |
...
| [ShapeShdwTypeValue](./shapeshdwtypevalue/) | Specifies the type of shadow for a shape. |
