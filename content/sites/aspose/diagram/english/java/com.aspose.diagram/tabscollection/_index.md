...
```
public class TabsCollection extends Collection<TabCollection>
```
...
| --- | --- |
| [add(T o)](#add-T-) |  |
| [add(TabCollection item)](#add-com.aspose.diagram.TabCollection-) | Add the Tab object in the collection. |
| [clear()](#clear--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(TabCollection item)](#remove-com.aspose.diagram.TabCollection-) | Remove the Tab object from the collection. |
