...
| Method | Description |
| --- | --- |
| [detectFileFormat(InputStream stream)](#detectFileFormat-java.io.InputStream-) | Detects and returns the information about a format of a visio stored in a stream. |
| [detectFileFormat(String filePath)](#detectFileFormat-java.lang.String-) | Detects and returns the information about a format of a visio stored in a file. |
