...
```
public class RuleSetCollection extends Collection<RuleSet>
```
...
| --- | --- |
| [add(T o)](#add-T-) |  |
| [add(RuleSet ruleSet)](#add-com.aspose.diagram.RuleSet-) | Add the ruleSet in the collection. |
| [clear()](#clear--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(RuleSet ruleSet)](#remove-com.aspose.diagram.RuleSet-) | Remove the ruleSet from the collection. |
