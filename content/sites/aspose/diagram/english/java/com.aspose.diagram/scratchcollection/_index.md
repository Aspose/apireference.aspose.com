...
```
public class ScratchCollection extends Collection<Scratch>
```
...
| --- | --- |
| [add(T o)](#add-T-) |  |
| [add(Scratch item)](#add-com.aspose.diagram.Scratch-) | Add the Scratch object in the collection. |
| [clear()](#clear--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Scratch item)](#remove-com.aspose.diagram.Scratch-) | Remove the Scratch object from the collection. |
