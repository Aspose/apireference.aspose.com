...
type: docs
weight: 464
url: /java/com.aspose.diagram/walkpreference/
---
...
| [getValue()](#getValue--) | Specifies whether an endpoint of a 1-D shape moves to a horizontal or vertical connection point on the shape it is glued to, using dynamic glue, when the shape is moved to an ambiguous position. |
