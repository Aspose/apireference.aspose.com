...
```
public class IssueCollection extends Collection<Issue>
```
...
| --- | --- |
| [add(T o)](#add-T-) |  |
| [add(Issue issue)](#add-com.aspose.diagram.Issue-) | Add the issue in the collection. |
| [clear()](#clear--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(Issue issue)](#remove-com.aspose.diagram.Issue-) | Remove the issue from the collection. |
