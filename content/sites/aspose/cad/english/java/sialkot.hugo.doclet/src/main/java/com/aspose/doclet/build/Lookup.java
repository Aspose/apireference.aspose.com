...
import com.aspose.doclet.model.ClassMetadataFile;
import com.aspose.doclet.model.MetadataFile;
import com.aspose.doclet.model.PackageMetadataFile;
...
public class Lookup {
    ...
    public Lookup(List<PackageMetadataFile> packageMetadataFiles, List<ClassMetadataFile> classMetadataFiles) {
        consume(packageMetadataFiles, "Package");
     ...
     */
    private void consume(List<ClassMetadataFile> metadataFiles) {
        metadataFiles.forEach(file -> consume(file));
    }
    private void consume(List<PackageMetadataFile> metadataFiles, String type) {
        metadataFiles.forEach(file -> consume(file));
    }
    private void consume(MetadataFile file)
    {
        /**
