---
title: user_defined_thermal_load_source property
...
```python
@property
def user_defined_thermal_load_source(self):
    ...
@user_defined_thermal_load_source.setter
def user_defined_thermal_load_source(self, value):
    ...
```
