...
type: docs
weight: 30
url: /python-net/aspose.cad.fileformats.cad.cadobjects/cadembeddedobjectcontainer/embedded_objects/
is_root: false
---
...
def embedded_objects(self):
    ...
@embedded_objects.setter
def embedded_objects(self, value):
    ...
```
