...
type: docs
weight: 20
url: /aspose.svg.dom.xpath/ixpathresult/iterate_next/
is_root: false
---
...
| :- | :- |
| [`DOMException`](./aspose.svg.dom/domexception) | TYPE_ERR: raised if `resultType` is not <br/>`UnorderedNodeIterator` type or `OrderedNodeIterator` type. |
| [`DOMException`](./aspose.svg.dom/domexception) | INVALID_STATE_ERR: The document has been mutated <br/>since the result was returned. |
