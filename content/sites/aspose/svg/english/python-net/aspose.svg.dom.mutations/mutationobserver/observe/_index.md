...
type: docs
weight: 40
url: /aspose.svg.dom.mutations/mutationobserver/observe/
is_root: false
---
...
| :- | :- | :- |
| target | [`Node`](./aspose.svg.dom/node) | The target for observe. |
...
| :- | :- | :- |
| target | [`Node`](./aspose.svg.dom/node) | The target for observe. |
| options | [`MutationObserverInit`](./aspose.svg.dom.mutations/mutationobserverinit) | The observer options. |
