...
type: docs
weight: 340
url: /aspose.svg.filters/svgfedisplacementmapelement/remove_event_listener/
is_root: false
---
...
If an [`IEventListener`](./aspose.svg.dom.events/ieventlistener) is removed from an [`EventTarget`](./aspose.svg.dom/eventtarget) while it is processing an event, it will not be triggered by the current actions.
...
| :- | :- | :- |
| type | str | Specifies the event type of the [`IEventListener`](./aspose.svg.dom.events/ieventlistener) being removed. |
| listener | aspose.svg.dom.events.IEventListener | The [`IEventListener`](./aspose.svg.dom.events/ieventlistener) parameter indicates the [`IEventListener`](./aspose.svg.dom.events/ieventlistener) to be removed. |
