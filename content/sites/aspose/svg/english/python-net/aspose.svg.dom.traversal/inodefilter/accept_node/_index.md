...
type: docs
weight: 20
url: /aspose.svg.dom.traversal/inodefilter/accept_node/
is_root: false
---
...
| :- | :- | :- |
| n | [`Node`](./aspose.svg.dom/node) | node to check to see if it passes the filter or not. |



### See Also
* module [`aspose.svg.dom.traversal`](../../)
* class [`INodeFilter`](./aspose.svg.dom.traversal/inodefilter)
