...
type: docs
weight: 20
url: /aspose.svg.rendering.pdf/ipdfdevicefactory/create/
is_root: false
---
...
| :- | :- | :- |
| options | [`PdfRenderingOptions`](./aspose.svg.rendering.pdf/pdfrenderingoptions) | The rendering options for the PDF device. See [`PdfRenderingOptions`](./aspose.svg.rendering.pdf/pdfrenderingoptions). |
| stream_provider | aspose.svg.io.ICreateStreamProvider | The stream provider used to create the PDF output stream. See [`ICreateStreamProvider`](./aspose.svg.io/icreatestreamprovider). |
...
* class [`IPdfDeviceFactory`](./aspose.svg.rendering.pdf/ipdfdevicefactory)
