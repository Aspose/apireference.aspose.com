...
type: docs
weight: 450
url: /aspose.svg/svgdocument/save/
is_root: false
---
...
| :- | :- | :- |
| url | [`Url`](./aspose.svg/url) | Local URL to output file. |
### Exceptions
...
| Parameter | Type | Description |
| :- | :- | :- |
| resource_handler | aspose.svg.saving.resourcehandlers.ResourceHandler | The resource handler [`ResourceHandler`](./aspose.svg.saving.resourcehandlers/resourcehandler). |
...
| Parameter | Type | Description |
| :- | :- | :- |
| output_storage | aspose.svg.io.IOutputStorage | The output storage [`IOutputStorage`](./aspose.svg.io/ioutputstorage). |
...
### See Also
* module [`aspose.svg`](../../)
* class [`IOutputStorage`](./aspose.svg.io/ioutputstorage)
