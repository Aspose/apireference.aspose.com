...
type: docs
weight: 100
url: /aspose.svg.drawing/idrawingfactory/create_texture_brush/
is_root: false
---
...
The created [`ITextureBrush`](./aspose.svg.drawing/itexturebrush).
...
| spread_mode | [`SpreadMode`](./aspose.svg.drawing/spreadmode) | The spread mode for the brush. See [`SpreadMode`](./aspose.svg.drawing/spreadmode). |
| opacity | float | The opacity of the brush. |
| transformation_matrix | [`IMatrix`](./aspose.svg.drawing/imatrix) | The transformation matrix for the brush. |
...
| transformation | [`IMatrix`](./aspose.svg.drawing/imatrix) | The transformation matrix for the brush. See [`IMatrix`](./aspose.svg.drawing/imatrix). |
| interpolation_colors | list | The interpolation colors for the brush. See [`IInterpolationColor`](./aspose.svg.drawing/iinterpolationcolor). |
...
* class [`IDrawingFactory`](./aspose.svg.drawing/idrawingfactory)
* class [`IInterpolationColor`](./aspose.svg.drawing/iinterpolationcolor)
* class [`IMatrix`](./aspose.svg.drawing/imatrix)
* class [`ITextureBrush`](./aspose.svg.drawing/itexturebrush)
* class [`SpreadMode`](./aspose.svg.drawing/spreadmode)
