...
type: docs
weight: 40
url: /aspose.svg.dom.events/ieventtarget/remove_event_listener/
is_root: false
---
...
| listener | [`IEventListener`](./aspose.svg.dom.events/ieventlistener) | The [`IEventListener`](./aspose.svg.dom.events/ieventlistener) parameter indicates the [`IEventListener`](./aspose.svg.dom.events/ieventlistener) to be removed. |
