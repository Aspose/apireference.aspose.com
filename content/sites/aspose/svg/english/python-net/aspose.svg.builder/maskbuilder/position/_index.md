...
type: docs
weight: 80
url: /aspose.svg.builder/maskbuilder/position/
is_root: false
---
...
| type | [`LengthType`](./aspose.svg.builder/lengthtype) | The type of length measurement. |
...
| Parameter | Type | Description |
| :- | :- | :- |
| horizontal | [`HorizontalPosition`](./aspose.svg.builder/horizontalposition) | The predefined horizontal position. |
| vertical | [`VerticalPosition`](./aspose.svg.builder/verticalposition) | The predefined vertical position. |
...
| Parameter | Type | Description |
| :- | :- | :- |
| horizontal_edge | [`HorizontalEdge`](./aspose.svg.builder/horizontaledge) | The horizontal edge position. |
| horizontal_value | float | The horizontal position value. |
| vertical_edge | [`VerticalEdge`](./aspose.svg.builder/verticaledge) | The vertical edge position. |
...
* class [`MaskBuilder`](./aspose.svg.builder/maskbuilder)
