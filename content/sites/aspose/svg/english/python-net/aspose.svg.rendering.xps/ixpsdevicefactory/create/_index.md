...
type: docs
weight: 20
url: /aspose.svg.rendering.xps/ixpsdevicefactory/create/
is_root: false
---
...
| :- | :- | :- |
| options | [`XpsRenderingOptions`](./aspose.svg.rendering.xps/xpsrenderingoptions) | The rendering options for the XPS device. See [`XpsRenderingOptions`](./aspose.svg.rendering.xps/xpsrenderingoptions). |
| stream_provider | aspose.svg.io.ICreateStreamProvider | The stream provider used to create the XPS output stream. See [`ICreateStreamProvider`](./aspose.svg.io/icreatestreamprovider). |
...
* class [`IXpsDeviceFactory`](./aspose.svg.rendering.xps/ixpsdevicefactory)
