...
description: 教程包含如何接受修订、获取修订类型、获取修订组、删除 PDF 中的注释、在气球中显示修订、获取修订组详细信息、访问修订版本、在跟踪文档中移动节点以及使用 Aspose.Words for .NET 塑造修订.
type: docs
weight: 1130
url: /zh/words/net/working-with-revisions/
---
...
| [在气球中显示评论](./show-revisions-in-balloons/) | 使用 Aspose.Words for .NET 在气球中显示修订。 |
