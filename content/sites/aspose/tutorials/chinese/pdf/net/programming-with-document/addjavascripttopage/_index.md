...
type: docs
weight: 10
url: /zh/pdf/net/programming-with-document/addjavascripttopage/
---
...
第一步是加载要添加 JavaScript 的 PDF 文件。您可以使用`Document`Aspose.PDF for .NET 提供的类。茶`Document`类提供加载、保存和操作 PDF 文件的方法。
