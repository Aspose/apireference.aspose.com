...
type: docs
weight: 370
url: /zh/pdf/net/programming-with-document/unembedfonts/
---
...
要从 PDF 文档中获取未嵌入的字体，您需要设置`UnembedFonts`选修的`true`.该选项在`OptimizationOptions`班级。下面的代码片段展示了如何设置`UnembedFonts`选项：
