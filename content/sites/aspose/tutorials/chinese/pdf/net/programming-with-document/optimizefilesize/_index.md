...
type: docs
weight: 250
url: /zh/pdf/net/programming-with-document/optimizefilesize/
---
...
加载 PDF 文档后，您可以设置优化选项以指定要优化文档的哪些部分。茶`OptimizationOptions`Aspose.PDF for .NET 库提供的类允许您指定各种选项来优化 PDF 文档的文件大小。以下是如何设置一些优化选项的示例：
