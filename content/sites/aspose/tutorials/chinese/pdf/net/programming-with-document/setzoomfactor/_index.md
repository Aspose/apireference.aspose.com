...
type: docs
weight: 340
url: /zh/pdf/net/programming-with-document/setzoomfactor/
---
...
此代码通过创建一个新的将缩放因子设置为 50%`GoToAction`对象并传递一个`XYZExplicitDestination`缩放系数为 50% 的对象。茶`OpenAction`的财产`Document`然后将对象设置为此`GoToAction`目的。
