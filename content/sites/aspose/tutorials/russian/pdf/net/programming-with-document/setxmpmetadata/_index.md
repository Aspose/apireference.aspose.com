...
Первый шаг — открыть файл PDF, для которого вы хотите установить метаданные XMP. Для этого вам нужно создать новый`Document` object и укажите путь к вашему файлу PDF.
