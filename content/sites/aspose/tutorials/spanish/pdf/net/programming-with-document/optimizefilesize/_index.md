...
type: docs
weight: 250
url: /es/pdf/net/programming-with-document/optimizefilesize/
---
...
Una vez que haya optimizado el documento PDF, puede guardar la versión optimizada en un archivo nuevo. Aquí hay un ejemplo de cómo guardar el documento PDF optimizado:
