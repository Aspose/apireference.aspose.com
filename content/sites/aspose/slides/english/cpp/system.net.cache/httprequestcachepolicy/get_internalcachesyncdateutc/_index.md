---
title: get_InternalCacheSyncDateUtc()
second_title: Aspose.Slides for C++ API Reference
description: Gets the time in the UTC format when resources stored in the cache must be revalidated. For internal use only.
type: docs
weight: 27
url: /cpp/system.net.cache/httprequestcachepolicy/get_internalcachesyncdateutc/
---
## HttpRequestCachePolicy::get_InternalCacheSyncDateUtc() const method
