---
title: set_FileNameStar
second_title: Aspose.Slides for C++ API Reference
description: Sets a value that determines how to construct filenames for storing the message payload. It is used when the entities are detached and stored in separate files.
type: docs
weight: 105
...
| --- | --- | --- |
| value | [String](../../../system/string/) | The value that will be set. |
