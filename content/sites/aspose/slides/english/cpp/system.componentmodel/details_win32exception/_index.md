...
description: "Throws an exception for a Win32 error code. Never create instances of this class manually. Use the Win32Exception class instead. Never wrap the Win32Exception class instances into System::SmartPtr."
type: docs
weight: 79
url: /cpp/system.componentmodel/details_win32exception/
---
## Details_Win32Exception class


Throws an exception for a Win32 error code. Never create instances of this class manually. Use the Win32Exception class instead. Never wrap the Win32Exception class instances into [System::SmartPtr](../../system/smartptr/).
...
| virtual **int32_t** [get_NativeErrorCode](./get_nativeerrorcode/)() const | Gets the Win32 error code associated with this exception. |
