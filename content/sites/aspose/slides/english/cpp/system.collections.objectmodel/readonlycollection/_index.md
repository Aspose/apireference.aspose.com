...
```cpp
template<typename T>class ReadOnlyCollection : public virtual System::Object,                                               public System::Collections::Generic::IList<T>
```
...
| **bool** [Contains](./contains/)(const T\&) const override | Checks if container contains specific item. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Copies container elements to existing array elements. |
...
| int [get_Count](./get_count/)() const override | Gets count of container elements. |
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | Checks whether the collection is of fixed size. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Checks if collection is read only. |
...
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | Gets collection enumerator. |
...
| T [idx_get](./idx_get/)(int) const override | Gets item at specific position. |
| int [IndexOf](./indexof/)(const T\&) const override | Looks for specific item in collection. |
...
|  [ReadOnlyCollection](./readonlycollection/)(const [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\>\&) | Wraps read-only collection around specific collection. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Does nothing as read-only collection only wraps data and stores nothing. |
