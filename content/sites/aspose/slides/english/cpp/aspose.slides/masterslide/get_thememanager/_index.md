...
type: docs
weight: 105
url: /cpp/aspose.slides/masterslide/get_thememanager/
---
## MasterSlide::get_ThemeManager() method


Returns the theme manager. Read-only [Theme::IMasterThemeManager](../../../aspose.slides.theme/imasterthememanager/).

```cpp
System::SharedPtr<Theme::IMasterThemeManager> Aspose::Slides::MasterSlide::get_ThemeManager() override
```
