...
type: docs
weight: 4239
url: /cpp/aspose.slides/masterslide/
---
## MasterSlide class
...
```cpp
class MasterSlide : public Aspose::Slides::BaseSlide,                    public Aspose::Slides::IMasterSlide
```
...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [ApplyExternalThemeToDependingSlides](./applyexternalthemetodependingslides/)([System::String](../../system/string/)) override | Creates a new master slide based on the current one, applying an external theme to it and applies the created master slide to all dependent slides. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextStyle](../itextstyle/)\> [get_BodyStyle](./get_bodystyle/)() override | Returns the style of a body text. Read-only [ITextStyle](../itextstyle/). |
...
| **bool** [get_HasDependingSlides](./get_hasdependingslides/)() override | Returns true if there exists at least one slide that depends on this master slide. Read-only **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlideHeaderFooterManager](../imasterslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() override | Returns HeaderFooter manager of the master slide. Read-only [IMasterSlideHeaderFooterManager](../imasterslideheaderfootermanager/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterLayoutSlideCollection](../imasterlayoutslidecollection/)\> [get_LayoutSlides](./get_layoutslides/)() override | Returns the collection of child layout slides for this master slide. Read-only [IMasterLayoutSlideCollection](../imasterlayoutslidecollection/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Returns the name of a master slide. Read [System::String](../../system/string/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITextStyle](../itextstyle/)\> [get_OtherStyle](./get_otherstyle/)() override | Returns the style of an other text. Read-only [ITextStyle](../itextstyle/). |
...
| **bool** [get_Preserve](./get_preserve/)() override | Determines whether the corresponding master is deleted when all the slides that follow that master are deleted. Note: [Aspose.Slides](../) will never remove any unused master by itself, to actually remove unused masters call [MasterSlideCollection::RemoveUnused](../masterslidecollection/removeunused/) Read **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextStyle](../itextstyle/)\> [get_TitleStyle](./get_titlestyle/)() override | Returns the style of a title text. Read-only [ITextStyle](../itextstyle/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Gets reference counter data structure associated with the object. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>\> [GetDependingSlides](./getdependingslides/)() override | Returns an array with all slides, which depend on this master slide. |
...
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Sets the name of a master slide. Write [System::String](../../system/string/). |
| void [set_Preserve](./set_preserve/)(**bool**) override | Determines whether the corresponding master is deleted when all the slides that follow that master are deleted. Note: [Aspose.Slides](../) will never remove any unused master by itself, to actually remove unused masters call [MasterSlideCollection::RemoveUnused](../masterslidecollection/removeunused/) Write **bool**. |
