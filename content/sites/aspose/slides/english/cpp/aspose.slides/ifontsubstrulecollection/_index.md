...
type: docs
weight: 2159
url: /cpp/aspose.slides/ifontsubstrulecollection/
---
...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IFontSubstRule](../ifontsubstrule/)\>) | Adds the new font substitution rule to the collection. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontSubstRule](../ifontsubstrule/)\> [idx_get](./idx_get/)(**int32_t**) | Gets the element at the specified index. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IFontSubstRule](../ifontsubstrule/)\>) | Removes the first occurrence of a specific object from the collection. |
