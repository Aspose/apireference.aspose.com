...
type: docs
weight: 131
url: /cpp/aspose.slides/fontsubstrulecollection/end/
---
## FontSubstRuleCollection::end() method


Gets iterator pointing right after the last element (if any) of the collection.

```cpp
iterator Aspose::Slides::FontSubstRuleCollection::end() noexcept
```
...
## FontSubstRuleCollection::end() const method


Gets iterator pointing right after the last element (if any) of the const-qualified instance of the collection.

```cpp
const_iterator Aspose::Slides::FontSubstRuleCollection::end() const noexcept
```
