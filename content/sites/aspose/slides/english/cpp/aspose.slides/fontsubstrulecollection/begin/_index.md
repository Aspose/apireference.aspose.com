...
type: docs
weight: 118
url: /cpp/aspose.slides/fontsubstrulecollection/begin/
---
## FontSubstRuleCollection::begin() method


Gets iterator pointing to the first element (if any) of the collection.

```cpp
iterator Aspose::Slides::FontSubstRuleCollection::begin() noexcept
```
...
## FontSubstRuleCollection::begin() const method


Gets iterator pointing to the first element (if any) of the const-qualified instance of the collection.

```cpp
const_iterator Aspose::Slides::FontSubstRuleCollection::begin() const noexcept
```
