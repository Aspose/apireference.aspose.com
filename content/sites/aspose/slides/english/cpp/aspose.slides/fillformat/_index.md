...
type: docs
weight: 833
url: /cpp/aspose.slides/fillformat/
---
## FillFormat class
...
| [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() override | Returns the type of filling. Read [Slides::FillType](../filltype/). |
...
| void [set_FillType](./set_filltype/)([Aspose::Slides::FillType](../filltype/)) override | Sets the type of filling. Write [Slides::FillType](../filltype/). |
| void [set_RotateWithShape](./set_rotatewithshape/)([NullableBool](../nullablebool/)) override | Determines whether the fill should be rotated with shape. Write [NullableBool](../nullablebool/). |
