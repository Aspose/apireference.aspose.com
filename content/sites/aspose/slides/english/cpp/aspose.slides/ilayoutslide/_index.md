...
type: docs
weight: 2471
url: /cpp/aspose.slides/ilayoutslide/
---
## ILayoutSlide class
...
| virtual **bool** [get_HasDependingSlides](./get_hasdependingslides/)() | Returns true if there exists at least one slide that depends on this layout slide. Read-only **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlideHeaderFooterManager](../ilayoutslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() | Returns HeaderFooter manager of the layout slide. Read-only [ILayoutSlideHeaderFooterManager](../ilayoutslideheaderfootermanager/). |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>\> [GetDependingSlides](./getdependingslides/)() | Returns an array with all slides, which depend on this layout slide. |
...
| virtual void [Remove](./remove/)() | Removes layout from presentation. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Decreases shared reference count by specified value. |
| virtual void [set_MasterSlide](./set_masterslide/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) | Sets the master slide for a layout. Write [IMasterSlide](../imasterslide/). |
