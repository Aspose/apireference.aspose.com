...
---
## IDocumentProperties::set_ApplicationTemplate(System::String) method


Sets the template of a application. Write [System::String](../../../system/string/).

```cpp
virtual void Aspose::Slides::IDocumentProperties::set_ApplicationTemplate(System::String value)=0
```
