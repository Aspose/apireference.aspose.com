...
type: docs
weight: 157
url: /cpp/aspose.slides/gradientstopcollectioneffectivedata/virtualizebeginconstiterator/
---
## GradientStopCollectionEffectiveData::virtualizeBeginConstIterator() const method


Gets iterator pointing to the first element (if any)of the const-qualified instance of the collection.

```cpp
virtualized_iterator * Aspose::Slides::GradientStopCollectionEffectiveData::virtualizeBeginConstIterator() const override
```
