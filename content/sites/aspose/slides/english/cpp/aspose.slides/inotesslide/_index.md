...
type: docs
weight: 2835
url: /cpp/aspose.slides/inotesslide/
---
## INotesSlide class
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[INotesSlideHeaderFooterManager](../inotesslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() | Returns HeaderFooter manager of the notes slide. Read-only [INotesSlideHeaderFooterManager](../inotesslideheaderfootermanager/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../itextframe/)\> [get_NotesTextFrame](./get_notestextframe/)() | Returns a [TextFrame](../textframe/) with notes' text if there is one. Read-only [ITextFrame](../itextframe/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_ParentSlide](./get_parentslide/)() | Returns a ParentSlide Read-only [ISlide](../islide/). |
