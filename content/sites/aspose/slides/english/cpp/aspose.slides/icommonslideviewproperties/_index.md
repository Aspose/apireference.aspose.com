...
type: docs
weight: 1743
url: /cpp/aspose.slides/icommonslideviewproperties/
---
...
| virtual void [set_Scale](./set_scale/)(**int32_t**) | Specifies the view scaling ratio in percentages. Write **int32_t**. |
| virtual void [set_VariableScale](./set_variablescale/)(**bool**) | Specifies that the view content should automatically scale to best fit the current window size. Write **bool**. |
