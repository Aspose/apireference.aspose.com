...
type: docs
weight: 209
url: /cpp/aspose.slides/autoshapelock/get_arrowheadslocked/
---
## AutoShapeLock::get_ArrowheadsLocked method


Determines whether a changing arrowheads is forbidden. Read **bool**.

```cpp
bool Aspose::Slides::AutoShapeLock::get_ArrowheadsLocked() override
```
