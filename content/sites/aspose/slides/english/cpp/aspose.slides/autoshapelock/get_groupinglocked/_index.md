...
type: docs
weight: 1
url: /cpp/aspose.slides/autoshapelock/get_groupinglocked/
---
## AutoShapeLock::get_GroupingLocked() method


Determines whether an adding this shape to a group is forbidden. Read **bool**.

```cpp
bool Aspose::Slides::AutoShapeLock::get_GroupingLocked() override
```
