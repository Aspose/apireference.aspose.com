...
type: docs
weight: 105
url: /cpp/aspose.slides/autoshapelock/get_positionlocked/
---
## AutoShapeLock::get_PositionLocked() method


Determines whether a moving this shape is forbidden. Read **bool**.

```cpp
bool Aspose::Slides::AutoShapeLock::get_PositionLocked() override
```
