...
type: docs
weight: 157
url: /cpp/aspose.slides/autoshapelock/get_editpointslocked/
---
## AutoShapeLock::get_EditPointsLocked() method


Determines whether a direct changing of contour of this shape is forbidden. Read **bool**.

```cpp
bool Aspose::Slides::AutoShapeLock::get_EditPointsLocked() override
```
