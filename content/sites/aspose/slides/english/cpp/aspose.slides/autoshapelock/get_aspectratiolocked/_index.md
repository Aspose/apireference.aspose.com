...
type: docs
weight: 79
url: /cpp/aspose.slides/autoshapelock/get_aspectratiolocked/
---
## AutoShapeLock::get_AspectRatioLocked method


Determines whether a shape have to preserve aspect ratio on resizing. Read **bool**.

```cpp
bool Aspose::Slides::AutoShapeLock::get_AspectRatioLocked() override
```
