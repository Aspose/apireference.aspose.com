...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) | Add a new FallBack rule to the end of the collection. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\> [idx_get](./idx_get/)(**int32_t**) | Gets the rule at the specified index. Read-only [IFontFallBackRule](../ifontfallbackrule/). |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) | Removes the first occurrence of a specific FallBack rule from the collection. |
