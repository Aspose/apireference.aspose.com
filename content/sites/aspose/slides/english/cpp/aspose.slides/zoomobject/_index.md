...
type: docs
weight: 5318
url: /cpp/aspose.slides/zoomobject/
---
## ZoomObject class
...
| **bool** [get_ReturnToParent](./get_returntoparent/)() override | Gets the navigation behavior in slideshow. Read **bool**. Default value: false |
...
| **bool** [get_ShowBackground](./get_showbackground/)() override | Gets value that specifies whether the Zoom will use the background of the destination slide. Read **bool**. Default value: true |
...
| **float** [get_TransitionDuration](./get_transitionduration/)() override | Gets the duration of the transition between Zoom and slide. Read **float**. Default value: 1.0f |
...
| void [set_ShowBackground](./set_showbackground/)(**bool**) override | Sets value that specifies whether the Zoom will use the background of the destination slide. Write **bool**. Default value: true |
| void [set_TransitionDuration](./set_transitionduration/)(**float**) override | Sets the duration of the transition between Zoom and slide. Write **float**. Default value: 1.0f |
