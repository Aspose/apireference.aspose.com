...
type: docs
weight: 209
url: /cpp/aspose.slides/ipictureframelock/get_arrowheadslocked/
---
## IPictureFrameLock::get_ArrowheadsLocked() method


Determines whether a changing arrowheads is forbidden. Read **bool**.

```cpp
virtual bool Aspose::Slides::IPictureFrameLock::get_ArrowheadsLocked()=0
```
