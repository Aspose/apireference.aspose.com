...
type: docs
weight: 27
url: /cpp/aspose.slides/isummaryzoomframe/get_summaryzoomsection/
---
## ISummaryZoomFrame::get_SummaryZoomSection(int32_t) method
...
```cpp
virtual System::SharedPtr<ISummaryZoomSection> Aspose::Slides::ISummaryZoomFrame::get_SummaryZoomSection(int32_t index)=0
```
