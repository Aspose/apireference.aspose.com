...
type: docs
weight: 14
url: /cpp/aspose.slides/shapecollection/get_parentgroup/
---
## ShapeCollection::get_ParentGroup() method


Returns parent [GroupShape](../../groupshape/) object for a shapes collection. Read-only [IGroupShape](../../igroupshape/).

```cpp
System::SharedPtr<IGroupShape> Aspose::Slides::ShapeCollection::get_ParentGroup() override
```
