...
type: docs
weight: 209
url: /cpp/aspose.slides/commentcollection/end/
---
## CommentCollection::end() method


Gets iterator pointing right after the last element (if any) of the collection.

```cpp
iterator Aspose::Slides::CommentCollection::end() noexcept
```
...
## CommentCollection::end() const method


Gets iterator pointing right after the last element (if any) of the const-qualified instance of the collection.

```cpp
const_iterator Aspose::Slides::CommentCollection::end() const noexcept
```
