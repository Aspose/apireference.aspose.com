...
type: docs
weight: 14
url: /cpp/aspose.slides/commentcollection/get_issynchronized/
---
## CommentCollection::get_IsSynchronized() method


Returns a value indicating whether access to the collection is synchronized (thread-safe). Read-only **bool**.

```cpp
bool Aspose::Slides::CommentCollection::get_IsSynchronized() override
```
