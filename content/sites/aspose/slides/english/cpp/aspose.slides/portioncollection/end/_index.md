...
type: docs
weight: 183
url: /cpp/aspose.slides/portioncollection/end/
---
## PortionCollection::end() method


Gets iterator pointing right after the last element (if any) of the collection.

```cpp
iterator Aspose::Slides::PortionCollection::end() noexcept
```
...
## PortionCollection::end() const method


Gets iterator pointing right after the last element (if any) of the const-qualified instance of the collection.

```cpp
const_iterator Aspose::Slides::PortionCollection::end() const noexcept
```
