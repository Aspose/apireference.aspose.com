...
| [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() override | [Camera](./) type. Read [CameraPresetType](../camerapresettype/). |
| **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() override | [Camera](./) FOV (0-180 deg, field of View). Read **float**. |
...
| **float** [get_Zoom](./get_zoom/)() override | [Camera](./) zoom (positive value in percentage). Read **float**. |
...
| void [set_CameraType](./set_cameratype/)([CameraPresetType](../camerapresettype/)) override | [Camera](./) type. Write [CameraPresetType](../camerapresettype/). |
| void [set_FieldOfViewAngle](./set_fieldofviewangle/)(**float**) override | [Camera](./) FOV (0-180 deg, field of View). Write **float**. |
| void [set_Zoom](./set_zoom/)(**float**) override | [Camera](./) zoom (positive value in percentage). Write **float**. |
