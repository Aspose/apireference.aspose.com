...
type: docs
weight: 209
url: /cpp/aspose.slides/summaryzoomsectioncollection/virtualizeenditerator/
---
## SummaryZoomSectionCollection::virtualizeEndIterator method


Gets iterator pointing right after the last element (if any) of the collection.

```cpp
virtualized_iterator * Aspose::Slides::SummaryZoomSectionCollection::virtualizeEndIterator() override
```
