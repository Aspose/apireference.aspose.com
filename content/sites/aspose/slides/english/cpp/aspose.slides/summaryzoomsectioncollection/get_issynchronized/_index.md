...
type: docs
weight: 14
url: /cpp/aspose.slides/summaryzoomsectioncollection/get_issynchronized/
---
## SummaryZoomSectionCollection::get_IsSynchronized method


Returns a value indicating whether access to the collection is synchronized (thread-safe). Read-only **bool**.

```cpp
bool Aspose::Slides::SummaryZoomSectionCollection::get_IsSynchronized() override
```
