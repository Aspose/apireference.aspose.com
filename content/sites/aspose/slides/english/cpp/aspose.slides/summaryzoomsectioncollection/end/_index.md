...
type: docs
weight: 157
url: /cpp/aspose.slides/summaryzoomsectioncollection/end/
---
## SummaryZoomSectionCollection::end() method


Gets iterator pointing right after the last element (if any) of the collection.

```cpp
iterator Aspose::Slides::SummaryZoomSectionCollection::end() noexcept
```
...
## SummaryZoomSectionCollection::end() const method


Gets iterator pointing right after the last element (if any) of the const-qualified instance of the collection.

```cpp
const_iterator Aspose::Slides::SummaryZoomSectionCollection::end() const noexcept
```
