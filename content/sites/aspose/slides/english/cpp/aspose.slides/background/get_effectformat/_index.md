...
type: docs
weight: 40
url: /cpp/aspose.slides/background/get_effectformat/
---
## Background::get_EffectFormat method
...
```cpp
System::SharedPtr<IEffectFormat> Aspose::Slides::Background::get_EffectFormat() override
```
