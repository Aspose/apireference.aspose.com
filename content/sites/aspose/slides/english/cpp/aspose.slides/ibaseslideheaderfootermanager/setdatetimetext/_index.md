...
---
## IBaseSlideHeaderFooterManager::SetDateTimeText(System::String) method


Sets text to slide date-time placeholder.

```cpp
virtual void Aspose::Slides::IBaseSlideHeaderFooterManager::SetDateTimeText(System::String text)=0
```
