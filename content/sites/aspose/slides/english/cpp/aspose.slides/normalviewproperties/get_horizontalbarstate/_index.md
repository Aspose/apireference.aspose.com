...
type: docs
weight: 79
url: /cpp/aspose.slides/normalviewproperties/get_horizontalbarstate/
---
## NormalViewProperties::get_HorizontalBarState method
...
```cpp
SplitterBarStateType Aspose::Slides::NormalViewProperties::get_HorizontalBarState() override
```
