...
type: docs
weight: 2185
url: /cpp/aspose.slides/igenericcloneable/
---
...
```cpp
template<typename T>class IGenericCloneable : public System::ICloneable
```
...
| virtual T [CloneT](./clonet/)() | Creates a new object that is a copy of the current instance. |
