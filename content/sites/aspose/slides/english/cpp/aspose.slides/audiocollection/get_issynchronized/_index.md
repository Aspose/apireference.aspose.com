...
type: docs
weight: 14
url: /cpp/aspose.slides/audiocollection/get_issynchronized/
---
## AudioCollection::get_IsSynchronized method


Returns a value indicating whether access to the collection is synchronized (thread-safe). Read-only **bool**.

```cpp
bool Aspose::Slides::AudioCollection::get_IsSynchronized() override
```
