...
type: docs
weight: 92
url: /cpp/aspose.slides/audiocollection/begin/
---
## AudioCollection::begin() method


Gets iterator pointing to the first element (if any) of the collection.

```cpp
iterator Aspose::Slides::AudioCollection::begin() noexcept
```
...
## AudioCollection::begin() const method


Gets iterator pointing to the first element (if any) of the const-qualified instance of the collection.

```cpp
const_iterator Aspose::Slides::AudioCollection::begin() const noexcept
```
