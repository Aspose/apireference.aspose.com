...
type: docs
weight: 40
url: /cpp/aspose.slides/itextframeformat/get_marginright/
---
## ITextFrameFormat::get_MarginRight method


Returns the right margin (points) in a [TextFrame](../../textframe/). Read **double**.

```cpp
virtual double Aspose::Slides::ITextFrameFormat::get_MarginRight()=0
```
