...
description: Returns number of columns in the text area. This value must be a positive number. Otherwise, the value will be set to zero. Value 0 means undefined value. Read int32_t.
type: docs
weight: 248
url: /cpp/aspose.slides/itextframeformat/get_columncount/
---
