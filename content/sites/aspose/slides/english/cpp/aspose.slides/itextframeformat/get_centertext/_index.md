...
type: docs
weight: 170
url: /cpp/aspose.slides/itextframeformat/get_centertext/
---
## ITextFrameFormat::get_CenterText() method


If [NullableBool::True](../../nullablebool/) then text should be centered in box horizontally. Read [NullableBool](../../nullablebool/).

```cpp
virtual NullableBool Aspose::Slides::ITextFrameFormat::get_CenterText()=0
```
