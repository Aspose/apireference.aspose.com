...
type: docs
weight: 183
url: /cpp/aspose.slides/iconnectorlock/get_adjusthandleslocked/
---
## IConnectorLock::get_AdjustHandlesLocked method


Determines whether a changing adjust values is forbidden. Read **bool**.

```cpp
virtual bool Aspose::Slides::IConnectorLock::get_AdjustHandlesLocked()=0
```
