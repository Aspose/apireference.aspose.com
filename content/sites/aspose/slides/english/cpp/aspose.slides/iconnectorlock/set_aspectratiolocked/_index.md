...
type: docs
weight: 92
url: /cpp/aspose.slides/iconnectorlock/set_aspectratiolocked/
---
## IConnectorLock::set_AspectRatioLocked(bool) method


Determines whether a shape have to preserve aspect ratio on resizing. Write **bool**.

```cpp
virtual void Aspose::Slides::IConnectorLock::set_AspectRatioLocked(bool value)=0
```
