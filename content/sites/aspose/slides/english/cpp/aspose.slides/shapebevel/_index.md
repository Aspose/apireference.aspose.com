...
description: Contains the properties of shape's main face relief.
type: docs
weight: 4837
url: /cpp/aspose.slides/shapebevel/
---
## ShapeBevel class
...
| [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() override | Bevel type. Read [BevelPresetType](../bevelpresettype/). |
| **double** [get_Height](./get_height/)() override | Bevel height. Read **double**. |
...
| **double** [get_Width](./get_width/)() override | Bevel width. Read **double**. |
...
| void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) override | Bevel type. Write [BevelPresetType](../bevelpresettype/). |
| void [set_Height](./set_height/)(**double**) override | Bevel height. Write **double**. |
| void [set_Width](./set_width/)(**double**) override | Bevel width. Write **double**. |
