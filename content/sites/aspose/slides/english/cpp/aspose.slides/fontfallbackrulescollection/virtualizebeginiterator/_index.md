...
type: docs
weight: 170
url: /cpp/aspose.slides/fontfallbackrulescollection/virtualizebeginiterator/
---
## FontFallBackRulesCollection::virtualizeBeginIterator() method


Gets iterator pointing to the first element (if any) of the collection.

```cpp
virtualized_iterator * Aspose::Slides::FontFallBackRulesCollection::virtualizeBeginIterator() override
```
