...
type: docs
weight: 3719
url: /cpp/aspose.slides/isummaryzoomsection/
---
...
| virtual [System::String](../../system/string/) [get_Description](./get_description/)() | Returns the text description of the Summary Zoom [Section](../section/) object. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [get_TargetSection](../isectionzoomframe/get_targetsection/)() | Gets the section object that the [Section](../section/) Zoom object is linked to. Read [ISection](../isection/). |
...
| virtual [System::String](../../system/string/) [get_Title](./get_title/)() | Returns the text title of the Summary Zoom [Section](../section/) object. |
...
| virtual void [set_Description](./set_description/)([System::String](../../system/string/)) | Returns the text description of the Summary Zoom [Section](../section/) object. |
...
| virtual void [set_TargetSection](../isectionzoomframe/set_targetsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) | Sets the section object that the [Section](../section/) Zoom object is linked to. Write [ISection](../isection/). |
| virtual void [set_Title](./set_title/)([System::String](../../system/string/)) | Returns the text title of the Summary Zoom [Section](../section/) object. |
