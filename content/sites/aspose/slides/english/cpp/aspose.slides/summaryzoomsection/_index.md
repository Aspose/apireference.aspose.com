...
type: docs
weight: 5071
url: /cpp/aspose.slides/summaryzoomsection/
---
...
| [System::String](../../system/string/) [get_Description](./get_description/)() override | Returns the text description of the Summary Zoom [Section](../section/) object. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [get_TargetSection](../sectionzoomframe/get_targetsection/)() override | Gets the section object that the [Section](../section/) Zoom object links to. Read [ISection](../isection/). |
...
| [System::String](../../system/string/) [get_Title](./get_title/)() override | Returns the text title of the Summary Zoom [Section](../section/) object. |
...
| void [set_Description](./set_description/)([System::String](../../system/string/)) override | Returns the text description of the Summary Zoom [Section](../section/) object. |
...
| void [set_TargetSection](../sectionzoomframe/set_targetsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Sets the section object that the [Section](../section/) Zoom object links to. Write [ISection](../isection/). |
| void [set_Title](./set_title/)([System::String](../../system/string/)) override | Returns the text title of the Summary Zoom [Section](../section/) object. |
