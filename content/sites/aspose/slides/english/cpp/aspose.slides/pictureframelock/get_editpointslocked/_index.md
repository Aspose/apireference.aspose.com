...
type: docs
weight: 157
url: /cpp/aspose.slides/pictureframelock/get_editpointslocked/
---
## PictureFrameLock::get_EditPointsLocked() method


Determines whether a direct changing of contour of this shape is forbidden. Read **bool**.

```cpp
bool Aspose::Slides::PictureFrameLock::get_EditPointsLocked() override
```
