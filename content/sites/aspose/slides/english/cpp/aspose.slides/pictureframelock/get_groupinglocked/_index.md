...
type: docs
weight: 1
url: /cpp/aspose.slides/pictureframelock/get_groupinglocked/
---
## PictureFrameLock::get_GroupingLocked method


Determines whether an adding this shape to a group is forbidden. Read **bool**.

```cpp
bool Aspose::Slides::PictureFrameLock::get_GroupingLocked() override
```
