...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColumnFormat](../icolumnformat/)\> [get_ColumnFormat](./get_columnformat/)() | Returns the [ColumnFormat](../columnformat/) object that contains formatting properties for this column. Read-only [IColumnFormat](../icolumnformat/). |
...
| virtual **double** [get_Width](./get_width/)() | Returns the width of a column. Read **double**. |
...
| virtual void [set_Width](./set_width/)(**double**) | Sets the width of a column. Write **double**. |
