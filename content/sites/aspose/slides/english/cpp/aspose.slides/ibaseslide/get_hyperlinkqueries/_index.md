...
type: docs
weight: 118
url: /cpp/aspose.slides/ibaseslide/get_hyperlinkqueries/
---
## IBaseSlide::get_HyperlinkQueries() method


Provides easy access to contained hyperlinks. Read-only [IHyperlinkQueries](../../ihyperlinkqueries/).

```cpp
virtual System::SharedPtr<IHyperlinkQueries> Aspose::Slides::IBaseSlide::get_HyperlinkQueries()=0
```
