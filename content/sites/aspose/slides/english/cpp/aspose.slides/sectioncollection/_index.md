...
type: docs
weight: 4785
url: /cpp/aspose.slides/sectioncollection/
---
...
```cpp
class SectionCollection : public Aspose::Slides::DomObject<System::SharedPtr<Aspose::Slides::Presentation>>,                          public Aspose::Slides::ISectionCollection
```
...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [AddEmptySection](./addemptysection/)([System::String](../../system/string/), **int32_t**) override | Add empty section to specified position of the collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [AddSection](./addsection/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) override | Add slides section started form specific slide. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [AppendEmptySection](./appendemptysection/)([System::String](../../system/string/)) override | Add empty section to the end of the collection. |
...
| void [Clear](./clear/)() override | Removes all sections from the collection. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>\>, **int32_t**) override | Copies the entire collection to the specified array. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>\>\> [GetEnumerator](./getenumerator/)() override | Returns an enumerator that iterates through the collection. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog of C# [Object.GetHashCode()](../../system/object/gethashcode/) method. Enables hashing of custom objects. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Gets actual type of object. Analog of C# [System.Object.GetType()](../../system/object/gettype/) call. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [idx_get](./idx_get/)(**int32_t**) override | Gets the element at the specified index. Read-only [ISection](../isection/). |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Returns an index of the specified section in the collection. |
...
| void [RemoveSection](./removesection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Remove section. [Slides](../) contained in the section will be merged into previous section. |
| void [RemoveSectionWithSlides](./removesectionwithslides/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Remove section and slides contained in the section. |
| void [ReorderSectionWithSlides](./reordersectionwithslides/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>, **int32_t**) override | Moves section and its slides from the collection to the specified position. |
