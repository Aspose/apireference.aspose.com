...
type: docs
weight: 1626
url: /cpp/aspose.slides/icoloroperationcollection/
---
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/), **float**) | Adds a new operation to the end of collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/)) | Adds a new operation to the end of collection. |
...
| virtual void [Clear](./clear/)() | Removes all color operations. |
...
| virtual T [CloneT](../igenericcloneable/clonet/)() | Creates a new object that is a copy of the current instance. |
...
| virtual **int32_t** [get_Count](../igenericcollection/get_count/)() | Returns the number of behaviors in a collection. Read-only **int32_t**. |
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Returns a value indicating whether access to the collection is synchronized (thread-safe). Read-only **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../igenericcollection/get_syncroot/)() | Returns a synchronization root. Read-only [System::Object](../../system/object/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [idx_get](./idx_get/)(**int32_t**) | Returns the operation at the specified index. Read [IColorOperation](../icoloroperation/). |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\>) | Sets the operation at the specified index. Write [IColorOperation](../icoloroperation/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/), **float**) | Inserts the new operation to a collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/)) | Inserts the new operation to a collection. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Removes the color operation from a collection. |
...
* Class [IGenericCollection](../igenericcollection/)
