...
type: docs
weight: 105
url: /cpp/aspose.slides/videocollection/end/
---
## VideoCollection::end() method


Gets iterator pointing right after the last element (if any) of the collection.

```cpp
iterator Aspose::Slides::VideoCollection::end() noexcept
```
...
## VideoCollection::end() const method


Gets iterator pointing right after the last element (if any) of the const-qualified instance of the collection.

```cpp
const_iterator Aspose::Slides::VideoCollection::end() const noexcept
```
