...
type: docs
weight: 92
url: /cpp/aspose.slides/videocollection/begin/
---
## VideoCollection::begin() method


Gets iterator pointing to the first element (if any) of the collection.

```cpp
iterator Aspose::Slides::VideoCollection::begin() noexcept
```
...
## VideoCollection::begin() const method


Gets iterator pointing to the first element (if any) of the const-qualified instance of the collection.

```cpp
const_iterator Aspose::Slides::VideoCollection::begin() const noexcept
```
