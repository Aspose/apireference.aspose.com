...
type: docs
weight: 1067
url: /cpp/aspose.slides/gradientstop/
---
## GradientStop class
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() override | Returns the color of a gradient stop. Read-only [IColorFormat](../icolorformat/). |
...
| **float** [get_Position](./get_position/)() override | Returns the position (0..1) of a gradient stop. Read **float**. |
...
| void [set_Position](./set_position/)(**float**) override | Sets the position (0..1) of a gradient stop. Write **float**. |
