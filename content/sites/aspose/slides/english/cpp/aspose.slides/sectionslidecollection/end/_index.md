...
type: docs
weight: 92
url: /cpp/aspose.slides/sectionslidecollection/end/
---
## SectionSlideCollection::end() method


Gets iterator pointing right after the last element (if any) of the collection.

```cpp
iterator Aspose::Slides::SectionSlideCollection::end() noexcept
```
...
## SectionSlideCollection::end() const method


Gets iterator pointing right after the last element (if any) of the const-qualified instance of the collection.

```cpp
const_iterator Aspose::Slides::SectionSlideCollection::end() const noexcept
```
