...
type: docs
weight: 1
url: /cpp/aspose.slides/sectionslidecollection/get_count/
---
## SectionSlideCollection::get_Count() method


Gets the number of elements actually contained in the collection. Read-only **int32_t**.

```cpp
int32_t Aspose::Slides::SectionSlideCollection::get_Count() override
```
