...
type: docs
weight: 79
url: /cpp/aspose.slides/sectionslidecollection/begin/
---
## SectionSlideCollection::begin() method


Gets iterator pointing to the first element (if any) of the collection.

```cpp
iterator Aspose::Slides::SectionSlideCollection::begin() noexcept
```
...
## SectionSlideCollection::begin() const method


Gets iterator pointing to the first element (if any) of the const-qualified instance of the collection.

```cpp
const_iterator Aspose::Slides::SectionSlideCollection::begin() const noexcept
```
