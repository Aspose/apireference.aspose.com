...
type: docs
weight: 131
url: /cpp/aspose.slides/sectionslidecollection/virtualizebeginiterator/
---
## SectionSlideCollection::virtualizeBeginIterator method


Gets iterator pointing to the first element (if any) of the collection.

```cpp
virtualized_iterator * Aspose::Slides::SectionSlideCollection::virtualizeBeginIterator() override
```
