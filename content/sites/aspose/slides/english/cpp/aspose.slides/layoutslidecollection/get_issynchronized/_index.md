...
type: docs
weight: 14
url: /cpp/aspose.slides/layoutslidecollection/get_issynchronized/
---
## LayoutSlideCollection::get_IsSynchronized() method


Returns a value indicating whether access to the collection is synchronized (thread-safe). Read-only **bool**.

```cpp
bool Aspose::Slides::LayoutSlideCollection::get_IsSynchronized() override
```
