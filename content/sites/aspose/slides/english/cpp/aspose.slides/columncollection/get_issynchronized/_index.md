...
type: docs
weight: 14
url: /cpp/aspose.slides/columncollection/get_issynchronized/
---
## ColumnCollection::get_IsSynchronized() method


Returns a value indicating whether access to the collection is synchronized (thread-safe). Read-only **bool**.

```cpp
bool Aspose::Slides::ColumnCollection::get_IsSynchronized() override
```
