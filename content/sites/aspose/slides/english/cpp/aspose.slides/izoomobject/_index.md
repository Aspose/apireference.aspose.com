...
type: docs
weight: 4044
url: /cpp/aspose.slides/izoomobject/
---
## IZoomObject class
...
| virtual **bool** [get_ReturnToParent](./get_returntoparent/)() | Gets the navigation behavior in slideshow. Read **bool**. Default value: false. |
...
| virtual **bool** [get_ShowBackground](./get_showbackground/)() | Gets value that specifies whether the Zoom will use the background of the destination slide. Read **bool**. Default value: true. |
...
| virtual **float** [get_TransitionDuration](./get_transitionduration/)() | Gets the duration of the transition between Zoom and slide. Read **float**. Default value: 1.0f. |
...
| virtual void [set_ShowBackground](./set_showbackground/)(**bool**) | Sets value that specifies whether the Zoom will use the background of the destination slide. Write **bool**. Default value: true. |
| virtual void [set_TransitionDuration](./set_transitionduration/)(**float**) | Sets the duration of the transition between Zoom and slide. Write **float**. Default value: 1.0f. |
