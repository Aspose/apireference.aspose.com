...
type: docs
weight: 14
url: /cpp/aspose.slides/tabcollection/get_issynchronized/
---
## TabCollection::get_IsSynchronized() method


Returns a value indicating whether access to the collection is synchronized (thread-safe). Read-only **bool**.

```cpp
bool Aspose::Slides::TabCollection::get_IsSynchronized() override
```
