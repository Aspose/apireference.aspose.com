...
type: docs
weight: 1
url: /cpp/aspose.slides/iparagraphcollection/get_count/
---
## IParagraphCollection::get_Count method


Gets the number of elements actually contained in the collection. Read-only **int32_t**.

```cpp
virtual int32_t Aspose::Slides::IParagraphCollection::get_Count()=0
```
