...
type: docs
weight: 2939
url: /cpp/aspose.slides/iparagraphcollection/
---
...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Adds a [Paragraph](../paragraph/) to the end of collection. |
| virtual **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](./)\>) | Adds a content of [ParagraphCollection](../paragraphcollection/) to the end of collection. |
| virtual void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/)) | Adds text from specified html string to the collection. |
| virtual void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\>, [System::String](../../system/string/)) | Adds text from specified html string to the collection. |
...
| virtual [System::String](../../system/string/) [ExportToHtml](./exporttohtml/)(**int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Export::ITextToHtmlConversionOptions](../../aspose.slides.export/itexttohtmlconversionoptions/)\>) | Converts specifying paragraphs to the HTML and returns it as String object. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | For internal purposes only. |
| virtual **int32_t** [get_Count](./get_count/)() | Gets the number of elements actually contained in the collection. Read-only **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [idx_get](./idx_get/)(**int32_t**) | Gets the element at the specified index. |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Inserts a [Paragraph](../paragraph/) into the collection at the specified index. |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](./)\>) | Inserts a content of [ParagraphCollection](../paragraphcollection/) into the collection at the specified index. |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Removes the first occurrence of a specific paragraph. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Removes the element at the specified index of the collection. |
