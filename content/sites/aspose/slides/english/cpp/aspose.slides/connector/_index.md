...
type: docs
weight: 456
url: /cpp/aspose.slides/connector/
---
## Connector class
...
| [System::SharedPtr](../../system/sharedptr/)\<[IConnectorLock](../iconnectorlock/)\> [get_ConnectorLock](./get_connectorlock/)() override | Returns connector's locks. Read-only [IConnectorLock](../iconnectorlock/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [get_EndShapeConnectedTo](./get_endshapeconnectedto/)() override | Returns the shape to attach the end of the connector to. Read [IShape](../ishape/). |
| **uint32_t** [get_EndShapeConnectionSiteIndex](./get_endshapeconnectionsiteindex/)() override | Returns the index of connection site for end shape. Read **uint32_t**. |
...
| [Aspose::Slides::ShapeType](../shapetype/) [get_ShapeType](./get_shapetype/)() override | Returns the [AutoShape](../autoshape/) type. Read [Slides::ShapeType](../shapetype/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [get_StartShapeConnectedTo](./get_startshapeconnectedto/)() override | Returns the shape to attach the beginning of the connector to. Read [IShape](../ishape/). |
| **uint32_t** [get_StartShapeConnectionSiteIndex](./get_startshapeconnectionsiteindex/)() override | Returns the index of connection site for start shape. Read **uint32_t**. |
...
| void [Reroute](./reroute/)() override | Reroutes connector so that it take the shortest possible path between the shapes it connect. |
...
| void [set_EndShapeConnectedTo](./set_endshapeconnectedto/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\>) override | Sets the shape to attach the end of the connector to. Write [IShape](../ishape/). |
| void [set_EndShapeConnectionSiteIndex](./set_endshapeconnectionsiteindex/)(**uint32_t**) override | Sets the index of connection site for end shape. Write **uint32_t**. |
...
| void [set_ShapeType](./set_shapetype/)([Aspose::Slides::ShapeType](../shapetype/)) override | Sets the [AutoShape](../autoshape/) type. Write [Slides::ShapeType](../shapetype/). |
| void [set_StartShapeConnectedTo](./set_startshapeconnectedto/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\>) override | Sets the shape to attach the beginning of the connector to. Write [IShape](../ishape/). |
| void [set_StartShapeConnectionSiteIndex](./set_startshapeconnectionsiteindex/)(**uint32_t**) override | Sets the index of connection site for start shape. Write **uint32_t**. |
