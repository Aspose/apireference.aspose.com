...
type: docs
weight: 222
url: /cpp/aspose.slides/coloroperationcollection/virtualizebeginiterator/
---
## ColorOperationCollection::virtualizeBeginIterator method


Gets iterator pointing to the first element (if any) of the collection.

```cpp
virtualized_iterator * Aspose::Slides::ColorOperationCollection::virtualizeBeginIterator() override
```
