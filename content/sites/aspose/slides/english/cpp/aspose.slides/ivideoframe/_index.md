...
type: docs
weight: 4005
url: /cpp/aspose.slides/ivideoframe/
---
## IVideoFrame class
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\> [get_EmbeddedVideo](./get_embeddedvideo/)() | Returns embedded video object. Read [IVideo](../ivideo/). |
...
| virtual **bool** [get_FullScreenMode](./get_fullscreenmode/)() | Determines whether a video is shown in full screen mode. Read **bool**. |
...
| virtual **bool** [get_HideAtShowing](./get_hideatshowing/)() | Determines whether a [VideoFrame](../videoframe/) is hidden. Read **bool**. |
...
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | Returns the name of an video file which is linked to a [VideoFrame](../videoframe/). Read [System::String](../../system/string/). |
...
| virtual **bool** [get_PlayLoopMode](./get_playloopmode/)() | Determines whether a video is looped. Read **bool**. |
| virtual [VideoPlayModePreset](../videoplaymodepreset/) [get_PlayMode](./get_playmode/)() | Returns the video play mode. Read [VideoPlayModePreset](../videoplaymodepreset/). |
...
| virtual **bool** [get_RewindVideo](./get_rewindvideo/)() | Determines whether a video is automatically rewinded to start as soon as the movie has finished playing. Read **bool**. |
...
| virtual void [set_EmbeddedVideo](./set_embeddedvideo/)([System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\>) | Sets embedded video object. Write [IVideo](../ivideo/). |
...
| virtual void [set_FullScreenMode](./set_fullscreenmode/)(**bool**) | Determines whether a video is shown in full screen mode. Write **bool**. |
...
| virtual void [set_HideAtShowing](./set_hideatshowing/)(**bool**) | Determines whether a [VideoFrame](../videoframe/) is hidden. Write **bool**. |
...
| virtual void [set_LinkPathLong](./set_linkpathlong/)([System::String](../../system/string/)) | Sets the name of an video file which is linked to a [VideoFrame](../videoframe/). Write [System::String](../../system/string/). |
...
| virtual void [set_PlayLoopMode](./set_playloopmode/)(**bool**) | Determines whether a video is looped. Write **bool**. |
| virtual void [set_PlayMode](./set_playmode/)([VideoPlayModePreset](../videoplaymodepreset/)) | Sets the video play mode. Write [VideoPlayModePreset](../videoplaymodepreset/). |
