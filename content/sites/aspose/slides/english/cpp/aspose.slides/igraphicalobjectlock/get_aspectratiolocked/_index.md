...
type: docs
weight: 79
url: /cpp/aspose.slides/igraphicalobjectlock/get_aspectratiolocked/
---
## IGraphicalObjectLock::get_AspectRatioLocked method


Determines whether shape have to preserve aspect ratio on resizing. Read **bool**.

```cpp
virtual bool Aspose::Slides::IGraphicalObjectLock::get_AspectRatioLocked()=0
```
