...
type: docs
weight: 313
url: /cpp/aspose.slides/slidecollection/virtualizebeginconstiterator/
---
## SlideCollection::virtualizeBeginConstIterator() const method


Gets iterator pointing to the first element (if any)of the const-qualified instance of the collection.

```cpp
virtualized_iterator * Aspose::Slides::SlideCollection::virtualizeBeginConstIterator() const override
```
