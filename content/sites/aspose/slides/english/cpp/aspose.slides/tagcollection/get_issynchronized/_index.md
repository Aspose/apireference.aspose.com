...
type: docs
weight: 14
url: /cpp/aspose.slides/tagcollection/get_issynchronized/
---
## TagCollection::get_IsSynchronized() method


Returns a value indicating whether access to the collection is synchronized (thread-safe). Read-only **bool**.

```cpp
bool Aspose::Slides::TagCollection::get_IsSynchronized() override
```
