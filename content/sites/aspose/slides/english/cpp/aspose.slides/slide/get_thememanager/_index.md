...
type: docs
weight: 14
url: /cpp/aspose.slides/slide/get_thememanager/
---
## Slide::get_ThemeManager() method


Returns the overriding theme manager. Read-only [Theme::IOverrideThemeManager](../../../aspose.slides.theme/ioverridethememanager/).

```cpp
System::SharedPtr<Theme::IOverrideThemeManager> Aspose::Slides::Slide::get_ThemeManager() override
```
