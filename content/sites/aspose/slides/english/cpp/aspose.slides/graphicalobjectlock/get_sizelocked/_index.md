...
type: docs
weight: 131
url: /cpp/aspose.slides/graphicalobjectlock/get_sizelocked/
---
## GraphicalObjectLock::get_SizeLocked() method


Determines whether resizing this shape is forbidden. Read **bool**.

```cpp
bool Aspose::Slides::GraphicalObjectLock::get_SizeLocked() override
```
