...
| virtual **double** [get_Height](./get_height/)() | Returns the height of a row. Read-only **double**. |
...
| virtual **double** [get_MinimalHeight](./get_minimalheight/)() | Returns the minimal possible height of a row. Read **double**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() | Returns the [RowFormat](../rowformat/) object that contains formatting properties for this row. Read-only [IRowFormat](../irowformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../icellcollection/idx_get/)(**int32_t**) | Returns a cell by it's position. Read-only [ICell](../icell/). |
...
| virtual void [set_MinimalHeight](./set_minimalheight/)(**double**) | Sets the minimal possible height of a row. Write **double**. |
...
* Class [ICellCollection](../icellcollection/)
