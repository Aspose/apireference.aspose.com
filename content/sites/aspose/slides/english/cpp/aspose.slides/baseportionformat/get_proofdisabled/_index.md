...
type: docs
weight: 183
url: /cpp/aspose.slides/baseportionformat/get_proofdisabled/
---
## BasePortionFormat::get_ProofDisabled method


Determines whether the text shouldn't be proofed. No inheritance applied. Read [NullableBool](../../nullablebool/).

```cpp
NullableBool Aspose::Slides::BasePortionFormat::get_ProofDisabled() override
```
