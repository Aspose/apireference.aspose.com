...
type: docs
weight: 53
url: /cpp/aspose.slides/inormalviewproperties/get_verticalbarstate/
---
## INormalViewProperties::get_VerticalBarState() method
...
```cpp
virtual SplitterBarStateType Aspose::Slides::INormalViewProperties::get_VerticalBarState()=0
```
