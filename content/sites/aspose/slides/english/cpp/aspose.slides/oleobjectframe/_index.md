...
type: docs
weight: 4369
url: /cpp/aspose.slides/oleobjectframe/
---
...
| [System::SharedPtr](../../system/sharedptr/)\<[IOleEmbeddedDataInfo](../ioleembeddeddatainfo/)\> [get_EmbeddedData](./get_embeddeddata/)() override | Gets information about OLE embedded data. Read [IOleEmbeddedDataInfo](../ioleembeddeddatainfo/). |
| [System::String](../../system/string/) [get_EmbeddedFileLabel](./get_embeddedfilelabel/)() override | Returns the file name of embedded OLE object. |
| [System::String](../../system/string/) [get_EmbeddedFileName](./get_embeddedfilename/)() override | Returns the path of embedded OLE object. |
...
| **bool** [get_IsObjectIcon](./get_isobjecticon/)() override | Determines whether an object is visible as icon. Read **bool**. |
| **bool** [get_IsObjectLink](./get_isobjectlink/)() override | Determines whether an object is linked to external file. Read-only **bool**. |
...
| [System::String](../../system/string/) [get_LinkFileName](./get_linkfilename/)() override | Returns the full path to a linked file. Short file name will be used. Read-only [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() override | Returns the full path to a linked file. Long file name will be used. Read [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_LinkPathRelative](./get_linkpathrelative/)() override | Returns the relative path to a linked file if present, otherwise returns an empty string. Readonly [System::String](../../system/string/). |
...
| [System::String](../../system/string/) [get_ObjectName](./get_objectname/)() override | Returns the name of an object. Read [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_ObjectProgId](./get_objectprogid/)() override | Returns the ProgID of an object. Read only [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_SubstitutePictureFormat](./get_substitutepictureformat/)() override | Returns OleObject image fill properties object. Read-only [IPictureFillFormat](../ipicturefillformat/). |
| [System::String](../../system/string/) [get_SubstitutePictureTitle](./get_substitutepicturetitle/)() override | Returns the title for OleObject icon. Read [System::String](../../system/string/). |
...
| **bool** [get_UpdateAutomatic](./get_updateautomatic/)() override | Determines if the linked embedded object is automatically updated when the presentation is opened or printed. Read **bool**. |
...
| void [set_IsObjectIcon](./set_isobjecticon/)(**bool**) override | Determines whether an object is visible as icon. Write **bool**. |
| void [set_LinkPathLong](./set_linkpathlong/)([System::String](../../system/string/)) override | Returns the full path to a linked file. Long file name will be used. Write [System::String](../../system/string/). |
...
| void [set_ObjectName](./set_objectname/)([System::String](../../system/string/)) override | Sets the name of an object. Write [System::String](../../system/string/). |
| void [set_ObjectProgId](./set_objectprogid/)([System::String](../../system/string/)) override | Returns the ProgID of an object. Read only [System::String](../../system/string/). |
...
| void [set_SubstitutePictureTitle](./set_substitutepicturetitle/)([System::String](../../system/string/)) override | Sets the title for OleObject icon. Write [System::String](../../system/string/). |
| void [set_UpdateAutomatic](./set_updateautomatic/)(**bool**) override | Determines if the linked embedded object is automatically updated when the presentation is opened or printed. Write **bool**. |
...
| void [SetEmbeddedData](./setembeddeddata/)([System::SharedPtr](../../system/sharedptr/)\<[IOleEmbeddedDataInfo](../ioleembeddeddatainfo/)\>) override | Sets information about OLE embedded data. |
