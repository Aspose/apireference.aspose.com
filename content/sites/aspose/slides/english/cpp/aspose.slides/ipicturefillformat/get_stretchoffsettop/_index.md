...
type: docs
weight: 196
url: /cpp/aspose.slides/ipicturefillformat/get_stretchoffsettop/
---
## IPictureFillFormat::get_StretchOffsetTop() method
...
```cpp
virtual float Aspose::Slides::IPictureFillFormat::get_StretchOffsetTop()=0
```
