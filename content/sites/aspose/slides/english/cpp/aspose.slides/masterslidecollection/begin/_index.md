...
type: docs
weight: 144
url: /cpp/aspose.slides/masterslidecollection/begin/
---
## MasterSlideCollection::begin() method


Gets iterator pointing to the first element (if any) of the collection.

```cpp
iterator Aspose::Slides::MasterSlideCollection::begin() noexcept
```
...
## MasterSlideCollection::begin() const method


Gets iterator pointing to the first element (if any) of the const-qualified instance of the collection.

```cpp
const_iterator Aspose::Slides::MasterSlideCollection::begin() const noexcept
```
