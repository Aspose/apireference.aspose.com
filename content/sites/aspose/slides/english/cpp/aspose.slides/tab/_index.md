...
| Method | Description |
| --- | --- |
| **int32_t** [CompareTo](./compareto/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) override | Compares the current instance with another object of the same type. |
...
| [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() override | Returns align style of a tab. Read [TabAlignment](../tabalignment/). |
...
| **double** [get_Position](./get_position/)() override | Returns position of a tab. Assigning this property can change tab's index in collection and invalidate Enumerator. Read **double**. |
...
| void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) override | Sets align style of a tab. Write [TabAlignment](../tabalignment/). |
| void [set_Position](./set_position/)(**double**) override | Sets position of a tab. Assigning this property can change tab's index in collection and invalidate Enumerator. Write **double**. |
