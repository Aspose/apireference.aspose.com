...
type: docs
weight: 79
url: /cpp/aspose.slides/ioleobjectframe/get_linkfilename/
---
## IOleObjectFrame::get_LinkFileName method


Returns the full path to a linked file. Short file name will be used. Read-only [System::String](../../../system/string/).

```cpp
virtual System::String Aspose::Slides::IOleObjectFrame::get_LinkFileName()=0
```
