...
type: docs
weight: 2913
url: /cpp/aspose.slides/ioleobjectframe/
---
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOleEmbeddedDataInfo](../ioleembeddeddatainfo/)\> [get_EmbeddedData](./get_embeddeddata/)() | Gets information about OLE embedded data. Read only [IOleEmbeddedDataInfo](../ioleembeddeddatainfo/). |
| virtual [System::String](../../system/string/) [get_EmbeddedFileLabel](./get_embeddedfilelabel/)() | Returns the file name of embedded OLE object. |
| virtual [System::String](../../system/string/) [get_EmbeddedFileName](./get_embeddedfilename/)() | Returns the path of embedded OLE object. |
...
| virtual **bool** [get_IsObjectIcon](./get_isobjecticon/)() | Determines whether an object is visible as icon. Read **bool**. |
| virtual **bool** [get_IsObjectLink](./get_isobjectlink/)() | Determines whether an object is linked to external file. Read-only **bool**. |
...
| virtual [System::String](../../system/string/) [get_LinkFileName](./get_linkfilename/)() | Returns the full path to a linked file. Short file name will be used. Read-only [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | Returns the full path to a linked file. Long file name will be used. Read [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_LinkPathRelative](./get_linkpathrelative/)() | Returns the relative path to a linked file if present, otherwise returns an empty string. Readonly [System::String](../../system/string/). |
...
| virtual [System::String](../../system/string/) [get_ObjectName](./get_objectname/)() | Returns the name of an object. Read [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_ObjectProgId](./get_objectprogid/)() | Returns the ProgID of an object. Read olny [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_SubstitutePictureFormat](./get_substitutepictureformat/)() | Returns OleObject image fill properties object. Read-only [IPictureFillFormat](../ipicturefillformat/). |
| virtual [System::String](../../system/string/) [get_SubstitutePictureTitle](./get_substitutepicturetitle/)() | Returns the title for OleObject icon. Read [System::String](../../system/string/). |
...
| virtual **bool** [get_UpdateAutomatic](./get_updateautomatic/)() | Determines if the linked embedded object is automatically updated when the presentation is opened or printed. Read **bool**. |
...
| virtual void [set_IsObjectIcon](./set_isobjecticon/)(**bool**) | Determines whether an object is visible as icon. Write **bool**. |
| virtual void [set_LinkPathLong](./set_linkpathlong/)([System::String](../../system/string/)) | Returns the full path to a linked file. Long file name will be used. Write [System::String](../../system/string/). |
...
| virtual void [set_ObjectName](./set_objectname/)([System::String](../../system/string/)) | Sets the name of an object. Write [System::String](../../system/string/). |
| virtual void [set_ObjectProgId](./set_objectprogid/)([System::String](../../system/string/)) | Returns the ProgID of an object. Read olny [System::String](../../system/string/). |
...
| virtual void [set_SubstitutePictureTitle](./set_substitutepicturetitle/)([System::String](../../system/string/)) | Sets the title for OleObject icon. Write [System::String](../../system/string/). |
| virtual void [set_UpdateAutomatic](./set_updateautomatic/)(**bool**) | Determines if the linked embedded object is automatically updated when the presentation is opened or printed. Write **bool**. |
...
| virtual void [SetEmbeddedData](./setembeddeddata/)([System::SharedPtr](../../system/sharedptr/)\<[IOleEmbeddedDataInfo](../ioleembeddeddatainfo/)\>) | Sets information about OLE embedded data. |
