...
type: docs
weight: 14
url: /cpp/aspose.slides/imagecollection/get_issynchronized/
---
## ImageCollection::get_IsSynchronized method


Returns a value indicating whether access to the collection is synchronized (thread-safe). Read-only **bool**.

```cpp
bool Aspose::Slides::ImageCollection::get_IsSynchronized() override
```
