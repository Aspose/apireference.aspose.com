...
description: Specifies the time, in milliseconds, after which the transition should start. This setting may be used in conjunction with the advClick attribute. If this attribute is not specified then it is assumed that no auto-advance will occur. Writes uint32_t.
type: docs
weight: 144
url: /cpp/aspose.slides/islideshowtransition/set_advanceaftertime/
---
## ISlideShowTransition::set_AdvanceAfterTime method
