...
type: docs
weight: 4330
url: /cpp/aspose.slides/notesslide/
---
## NotesSlide class
...
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlideHeaderFooterManager](../inotesslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() override | Returns HeaderFooter manager of the notes slide. Read-only [INotesSlideHeaderFooterManager](../inotesslideheaderfootermanager/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../itextframe/)\> [get_NotesTextFrame](./get_notestextframe/)() override | Returns a [TextFrame](../textframe/) with notes' text if there is one. Read-only [ITextFrame](../itextframe/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_ParentSlide](./get_parentslide/)() override | Returns the parent slide. Read-only [ISlide](../islide/). |
