...
type: docs
weight: 183
url: /cpp/aspose.slides/paragraphcollection/begin/
---
## ParagraphCollection::begin() method


Gets iterator pointing to the first element (if any) of the collection.

```cpp
iterator Aspose::Slides::ParagraphCollection::begin() noexcept
```
...
## ParagraphCollection::begin() const method


Gets iterator pointing to the first element (if any) of the const-qualified instance of the collection.

```cpp
const_iterator Aspose::Slides::ParagraphCollection::begin() const noexcept
```
