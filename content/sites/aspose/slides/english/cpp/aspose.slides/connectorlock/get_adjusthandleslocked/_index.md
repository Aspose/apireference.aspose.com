...
type: docs
weight: 183
url: /cpp/aspose.slides/connectorlock/get_adjusthandleslocked/
---
## ConnectorLock::get_AdjustHandlesLocked() method


Determines whether a changing adjust values is forbidden. Read **bool**.

```cpp
bool Aspose::Slides::ConnectorLock::get_AdjustHandlesLocked() override
```
