...
type: docs
weight: 1
url: /cpp/aspose.slides/commentauthorcollection/get_count/
---
## CommentAuthorCollection::get_Count() method


Gets the number of elements actually contained in the collection. Read-only **int32_t**.

```cpp
int32_t Aspose::Slides::CommentAuthorCollection::get_Count() override
```
