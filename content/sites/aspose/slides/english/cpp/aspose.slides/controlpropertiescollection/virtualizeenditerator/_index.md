...
type: docs
weight: 170
url: /cpp/aspose.slides/controlpropertiescollection/virtualizeenditerator/
---
## ControlPropertiesCollection::virtualizeEndIterator() method


Gets iterator pointing right after the last element (if any) of the collection.

```cpp
virtualized_iterator * Aspose::Slides::ControlPropertiesCollection::virtualizeEndIterator() override
```
