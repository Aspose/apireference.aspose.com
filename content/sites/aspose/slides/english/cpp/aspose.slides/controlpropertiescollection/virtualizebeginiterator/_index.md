...
type: docs
weight: 157
url: /cpp/aspose.slides/controlpropertiescollection/virtualizebeginiterator/
---
## ControlPropertiesCollection::virtualizeBeginIterator() method


Gets iterator pointing to the first element (if any) of the collection.

```cpp
virtualized_iterator * Aspose::Slides::ControlPropertiesCollection::virtualizeBeginIterator() override
```
