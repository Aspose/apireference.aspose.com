...
type: docs
weight: 4356
url: /cpp/aspose.slides/notesslidemanager/
---
...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [AddNotesSlide](./addnotesslide/)() override | Returns the notes slide for the current slide, creating one if there isn't. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [get_NotesSlide](./get_notesslide/)() override | Returns the notes slide for the current slide. Returns null if slide doesn't have notes slide. Read-only [INotesSlide](../inotesslide/). |
...
| void [RemoveNotesSlide](./removenotesslide/)() override | Removes notes slide of the current slide. |
...
The following example shows how to Add Notes to specific PowerPoint [Presentation](../presentation/) slide. 
```cpp
...
```
 The following examples shows how to remove Notes from PowerPoint [Presentation](../presentation/)'s specific slide. 
```cpp
// Instantiate a Presentation object that represents a presentation file
auto presentation = System::MakeObject<Presentation>(dataDir + u"AccessSlides.pptx");
