...
type: docs
weight: 1
url: /cpp/aspose.slides/masternotesslide/get_showmastershapes/
---
## MasterNotesSlide::get_ShowMasterShapes() method
...
```cpp
bool Aspose::Slides::MasterNotesSlide::get_ShowMasterShapes() override
```
