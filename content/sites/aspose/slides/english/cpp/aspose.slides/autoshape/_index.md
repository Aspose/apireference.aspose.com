...
type: docs
weight: 66
url: /cpp/aspose.slides/autoshape/
---
## AutoShape class
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../itextframe/)\> [AddTextFrame](./addtextframe/)([System::String](../../system/string/)) override | Adds a new [TextFrame](../textframe/) to a shape. If shape already has [TextFrame](../textframe/) then simply changes its text. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAutoShapeLock](../iautoshapelock/)\> [get_AutoShapeLock](./get_autoshapelock/)() override | Returns autoshape's locks. Read-only [IAutoShapeLock](../iautoshapelock/). |
...
| **bool** [get_IsTextBox](./get_istextbox/)() override | Specifies if the shape is a text box. |
...
| [Aspose::Slides::ShapeType](../shapetype/) [get_ShapeType](../geometryshape/get_shapetype/)() override | Returns the geometry preset type. Note: on value changing all adjustment values will reset to their default values. Read [Slides::ShapeType](../shapetype/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../itextframe/)\> [get_TextFrame](./get_textframe/)() override | Returns [TextFrame](../textframe/) object for the [AutoShape](./). Read-only [ITextFrame](../itextframe/). |
...
| **bool** [get_UseBackgroundFill](./get_usebackgroundfill/)() override | Determines whether this autoshape should be filled with slide's background fill instead of specified by style or fill format. Read **bool**. |
...
| void [set_ShapeType](../geometryshape/set_shapetype/)([Aspose::Slides::ShapeType](../shapetype/)) override | Sets the geometry preset type. Note: on value changing all adjustment values will reset to their default values. Write [Slides::ShapeType](../shapetype/). |
| void [set_UseBackgroundFill](./set_usebackgroundfill/)(**bool**) override | Determines whether this autoshape should be filled with slide's background fill instead of specified by style or fill format. Write **bool**. |
