...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const **bool**\&) override | Adds value to the end of container. |
| [BitArrayPtr](../bitarrayptr/) [And](./and/)(const [BitArrayPtr](../bitarrayptr/)\&) | Calculates bitwise 'and' between two BitSets. |
...
|  [BitArray](./bitarray/)(const [bitset](./bitset/)\&) | Copy constructor. |
|  [BitArray](./bitarray/)(const [BitArray](./)\&) | Copy constructor. |
|  [BitArray](./bitarray/)(const [BitArrayPtr](../bitarrayptr/)\&) | Copy constructor. |
|  [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<**bool**\>\&) | Copy constructor. |
|  [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Copy constructor. |
|  [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<int\>\&) | Copy constructor. |
...
| **bool** [Contains](./contains/)(const **bool**\&) const override | Checks whether specific value is present in container. Not implemented. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<**bool**\>, int) override | Copies data to existing array elements. |
| [bitset](./bitset/)\& [data](./data/)() | Underlying data structure access. |
| const [bitset](./bitset/)\& [data](./data/)() const | Underlying data structure access. |
...
| **bool** [Get](./get/)(int) const | Gets [BitArray](./) element. |
| int [get_Count](./get_count/)() const override | Gets container size. |
...
| int [get_Length](./get_length/)() const | Gets container size. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<**bool**\>\> [GetEnumerator](./getenumerator/)() override | Creates enumerator object. |
...
| **bool** [idx_get](./idx_get/)(int) const | Getter function. |
| void [idx_set](./idx_set/)(int, **bool**) | Setter function. |
...
| [BitArrayPtr](../bitarrayptr/) [Not](./not/)() | Negates BitSet. |
|  [Object](../../system/object/object/)() | Creates object. Initializes all internal data structures. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy constructor. Doesn't copy anything, really, just initializes new object and enables copy constructing subclasses. |
| **bool** [operator!=](./operator_not_equal/)(const [BitArray](./)\&) const | Bitwise comparison operator. |
...
| **bool** [operator==](./operator_equal_equal/)(const [BitArray](./)\&) const | Bitwise comparison operator. |
| **Reference** [operator[]](./operator[]/)(int) | Accessor function. |
| [BitArrayPtr](../bitarrayptr/) [Or](./or/)(const [BitArrayPtr](../bitarrayptr/)\&) | Calculates bitwise 'or' between two BitSets. |
...
| **bool** [Remove](./remove/)(const **bool**\&) override | Returns first occurance of specified value. Not implemented. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Decreases shared reference count by specified value. |
| void [Set](./set/)(int, **bool**) | Sets [BitArray](./) element. |
| void [SetAll](./setall/)(**bool**) | Sets all elements to specific value. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Formal implementation of weak template arguments mechanism; inapplicable to this class. |
...
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Gets the implementation of begin const iterator for the current container. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Gets the implementation of begin iterator for the current container. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Gets the implementation of end const iterator for the current container. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Gets the implementation of end iterator for the current container. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Increments weak reference count. Shouldn't be called directly; instead, use smart pointers or ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrements weak reference count. Shouldn't be called directly; instead, use smart pointers or ThisProtector. |
| [BitArrayPtr](../bitarrayptr/) [Xor](./xor/)(const [BitArrayPtr](../bitarrayptr/)\&) | Calculates bitwise 'xor' between two BitSets. |
...
| Typedef | Description |
| --- | --- |
| [bitset](./bitset/) | Underlying data type. |
## Remarks
