...
description: "The base exception type for all COM interop exceptions and structured exception handling (SEH) exceptions. Never create instances of this class manually. Use the ExternalException class instead. Never wrap the ExternalException class instances into System::SmartPtr."
type: docs
weight: 1
url: /cpp/system.runtime.interopservices/details_externalexception/
---
## Details_ExternalException class


The base exception type for all COM interop exceptions and structured exception handling (SEH) exceptions. Never create instances of this class manually. Use the ExternalException class instead. Never wrap the ExternalException class instances into [System::SmartPtr](../../system/smartptr/).
...
| virtual **int32_t** [get_ErrorCode](../../system/details_exceptionwitherrorcode/get_errorcode/)() const | Gets the HRESULT of the error. |
...
* Class [Details_ExceptionWithErrorCode](../../system/details_exceptionwitherrorcode/)
