...
type: docs
weight: 1
url: /cpp/system.xml.schema/details_xmlschemaexception/
---
## Details_XmlSchemaException class
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Returns the line number indicating where the error occurred. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Returns the line position indicating where the error occurred. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Returns the description of the error condition of this exception. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](./get_sourceschemaobject/)() | The **[XmlSchemaObject](../xmlschemaobject/)** that produced the XmlSchemaException. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Returns the Uniform Resource Identifier (URI) location of the schema that caused the exception. |
