...
description: Returns information about errors encountered by the XmlSchemaInference class while inferring a schema from an XML document.
type: docs
weight: 14
url: /cpp/system.xml.schema/details_xmlschemainferenceexception/
---
## Details_XmlSchemaInferenceException class


Returns information about errors encountered by the [XmlSchemaInference](../xmlschemainference/) class while inferring a schema from an XML document.
