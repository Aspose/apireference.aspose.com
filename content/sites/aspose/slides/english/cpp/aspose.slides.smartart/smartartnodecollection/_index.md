...
type: docs
weight: 92
url: /cpp/aspose.slides.smartart/smartartnodecollection/
---
## SmartArtNodeCollection class


Represents a collection of [SmartArt](../smartart/) nodes.
...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNode](../ismartartnode/)\>\>, **int32_t**) override | Copies all elements from the collection to the specified array. |
...
| **int32_t** [get_Count](./get_count/)() override | Returns count of nodes in collection Read-only **int32_t** Read-only **int32_t**. |
