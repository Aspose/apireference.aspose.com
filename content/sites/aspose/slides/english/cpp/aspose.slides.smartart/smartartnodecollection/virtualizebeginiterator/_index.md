...
type: docs
weight: 170
url: /cpp/aspose.slides.smartart/smartartnodecollection/virtualizebeginiterator/
---
## SmartArtNodeCollection::virtualizeBeginIterator method


Gets iterator pointing to the first element (if any) of the collection.

```cpp
virtualized_iterator * Aspose::Slides::SmartArt::SmartArtNodeCollection::virtualizeBeginIterator() override
```
