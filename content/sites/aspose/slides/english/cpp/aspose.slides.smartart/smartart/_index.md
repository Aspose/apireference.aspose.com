...
| [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNodeCollection](../ismartartnodecollection/)\> [get_AllNodes](./get_allnodes/)() override | Returns collections of all nodes in the [SmartArt](./) object. Read-only [ISmartArtNodeCollection](../ismartartnodecollection/). |
...
| [SmartArtColorType](../smartartcolortype/) [get_ColorStyle](./get_colorstyle/)() override | Returns color style of [SmartArt](./) object. Read [SmartArtColorType](../smartartcolortype/). |
...
| [SmartArtLayoutType](../smartartlayouttype/) [get_Layout](./get_layout/)() override | Returns layout of the [SmartArt](./) object. Read [SmartArtLayoutType](../smartartlayouttype/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNode](../ismartartnode/)\> [get_Node](./get_node/)(**int32_t**) override | Returns a node from collection of root nodes in [SmartArt](./) object at specified index. Read-only [Aspose::Slides::SmartArt::ISmartArtNode](../ismartartnode/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNode](../ismartartnode/)\> [get_NodeFromAll](./get_nodefromall/)(**int32_t**) override | Returns a node from collection with all nodes in [SmartArt](./) object at specified index. Read-only [Aspose::Slides::SmartArt::ISmartArtNode](../ismartartnode/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNodeCollection](../ismartartnodecollection/)\> [get_Nodes](./get_nodes/)() override | Returns collections of root nodes in [SmartArt](./) object. Read-only [ISmartArtNodeCollection](../ismartartnodecollection/). |
...
| [SmartArtQuickStyleType](../smartartquickstyletype/) [get_QuickStyle](./get_quickstyle/)() override | Returns quick style of [SmartArt](./) object. Read [SmartArtQuickStyleType](../smartartquickstyletype/). |
...
| void [set_ColorStyle](./set_colorstyle/)([SmartArtColorType](../smartartcolortype/)) override | Sets color style of [SmartArt](./) object. Write [SmartArtColorType](../smartartcolortype/). |
...
| void [set_QuickStyle](./set_quickstyle/)([SmartArtQuickStyleType](../smartartquickstyletype/)) override | Sets quick style of [SmartArt](./) object. Write [SmartArtQuickStyleType](../smartartquickstyletype/). |
