...
type: docs
weight: 1
url: /cpp/aspose.slides.smartart/smartartshapecollection/get_count/
---
## SmartArtShapeCollection::get_Count() method


Gets the number of elements actually contained in the collection. Read-only **int32_t**.

```cpp
int32_t Aspose::Slides::SmartArt::SmartArtShapeCollection::get_Count() override
```
