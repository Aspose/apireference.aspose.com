...
type: docs
weight: 144
url: /cpp/aspose.slides.smartart/smartartshapecollection/virtualizeenditerator/
---
## SmartArtShapeCollection::virtualizeEndIterator method


Gets iterator pointing right after the last element (if any) of the collection.

```cpp
virtualized_iterator * Aspose::Slides::SmartArt::SmartArtShapeCollection::virtualizeEndIterator() override
```
