...
type: docs
weight: 131
url: /cpp/aspose.slides.smartart/smartartshapecollection/virtualizebeginiterator/
---
## SmartArtShapeCollection::virtualizeBeginIterator() method


Gets iterator pointing to the first element (if any) of the collection.

```cpp
virtualized_iterator * Aspose::Slides::SmartArt::SmartArtShapeCollection::virtualizeBeginIterator() override
```
