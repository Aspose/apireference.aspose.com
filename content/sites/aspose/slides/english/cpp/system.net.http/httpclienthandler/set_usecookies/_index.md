---
title: set_UseCookies
second_title: Aspose.Slides for C++ API Reference
description: Sets the value that indicates if the current instance uses the cookie container to store server cookies and if the instance uses server cookies when sending requests.
type: docs
weight: 92
