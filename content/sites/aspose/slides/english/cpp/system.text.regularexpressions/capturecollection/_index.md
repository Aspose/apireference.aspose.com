...
| void [Clear](./clear/)() override | Disables cleaning collection. |
...
| int [get_Count](./get_count/)() const override | Gets number of captures. |
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | Checks whether the collection is of fixed size. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Marks collection as read-only. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() const | Marks collection as unsynchronized. |
...
| **bool** [Remove](./remove/)(const [CapturePtr](../captureptr/)\&) override | Disables collection ammendment. |
