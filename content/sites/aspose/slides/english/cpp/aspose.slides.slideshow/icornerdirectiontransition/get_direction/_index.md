...
type: docs
weight: 1
url: /cpp/aspose.slides.slideshow/icornerdirectiontransition/get_direction/
---
## ICornerDirectionTransition::get_Direction method


Direction of transition. Read [TransitionCornerDirectionType](../../transitioncornerdirectiontype/).

```cpp
virtual TransitionCornerDirectionType Aspose::Slides::SlideShow::ICornerDirectionTransition::get_Direction()=0
```
