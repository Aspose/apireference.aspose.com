...
type: docs
weight: 1
url: /cpp/aspose.slides.slideshow/glittertransition/get_direction/
---
## GlitterTransition::get_Direction() method


Direction of transition. Read [TransitionSideDirectionType](../../transitionsidedirectiontype/).

```cpp
TransitionSideDirectionType Aspose::Slides::SlideShow::GlitterTransition::get_Direction() override
```
