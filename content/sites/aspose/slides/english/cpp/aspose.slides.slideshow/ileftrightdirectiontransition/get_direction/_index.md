...
type: docs
weight: 1
url: /cpp/aspose.slides.slideshow/ileftrightdirectiontransition/get_direction/
---
## ILeftRightDirectionTransition::get_Direction method


Direction of transition. Read [TransitionLeftRightDirectionType](../../transitionleftrightdirectiontype/).

```cpp
virtual TransitionLeftRightDirectionType Aspose::Slides::SlideShow::ILeftRightDirectionTransition::get_Direction()=0
```
