...
---
## LeftRightDirectionTransition::set_Direction method


Direction of transition. Write [TransitionLeftRightDirectionType](../../transitionleftrightdirectiontype/).

```cpp
void Aspose::Slides::SlideShow::LeftRightDirectionTransition::set_Direction(TransitionLeftRightDirectionType value) override
```
