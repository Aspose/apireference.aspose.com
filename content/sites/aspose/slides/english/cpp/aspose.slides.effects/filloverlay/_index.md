...
type: docs
weight: 170
url: /cpp/aspose.slides.effects/filloverlay/
---
## FillOverlay class
...
```cpp
class FillOverlay : public Aspose::Slides::Effects::ImageTransformOperation,                    public Aspose::Slides::Effects::IFillOverlay,                    public Aspose::Slides::Effects::IVisualEffect
```
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determines whether the specified [FillOverlay](./) is equal to the current [FillOverlay](./). |
...
| [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() override | FillBlendMode. Read [FillBlendMode](../../aspose.slides/fillblendmode/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Fill format. Read-only [IFillFormat](../../aspose.slides/ifillformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillOverlayEffectiveData](../ifilloverlayeffectivedata/)\> [GetEffective](./geteffective/)() override | Gets effective Fill Overlay effect data with the inheritance applied. |
...
| void [set_Blend](./set_blend/)([FillBlendMode](../../aspose.slides/fillblendmode/)) override | FillBlendMode. Write [FillBlendMode](../../aspose.slides/fillblendmode/). |
