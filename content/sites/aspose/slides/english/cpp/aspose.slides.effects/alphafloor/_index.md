...
type: docs
weight: 27
url: /cpp/aspose.slides.effects/alphafloor/
---
## AlphaFloor class
...
```cpp
class AlphaFloor : public Aspose::Slides::Effects::ImageTransformOperation,                   public Aspose::Slides::Effects::IAlphaFloor,                   public Aspose::Slides::Effects::IVisualEffect
```
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determines whether the specified [AlphaFloor](./) is equal to the current [AlphaFloor](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaFloorEffectiveData](../ialphaflooreffectivedata/)\> [GetEffective](./geteffective/)() override | Gets effective Alpha Floor effect data with the inheritance applied. |
