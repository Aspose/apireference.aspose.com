...
type: docs
weight: 209
url: /cpp/aspose.slides.effects/hsl/
---
## HSL class
...
```cpp
class HSL : public Aspose::Slides::Effects::ImageTransformOperation,            public Aspose::Slides::Effects::IHSL,            public Aspose::Slides::Effects::IVisualEffect
```
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determines whether the specified [HSL](./) is equal to the current [HSL](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IHSLEffectiveData](../ihsleffectivedata/)\> [GetEffective](./geteffective/)() override | Gets effective Hue/Saturation/Luminance effect data with the inheritance applied. |
