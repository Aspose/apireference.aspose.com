...
type: docs
weight: 105
url: /cpp/aspose.slides.effects/blur/
---
## Blur class
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determines whether the specified [Blur](./) is equal to the current [Blur](./). |
...
| **bool** [get_Grow](./get_grow/)() override | Determines whether the bounds of the object should be grown as a result of the blurring. True indicates the bounds are grown while false indicates that they are not. Read **bool**. |
...
| **double** [get_Radius](./get_radius/)() override | Returns blur radius. Read **double**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Gets reference counter data structure associated with the object. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBlurEffectiveData](../iblureffectivedata/)\> [GetEffective](./geteffective/)() override | Gets effective [Blur](./) effect data with the inheritance applied. |
...
| void [set_Grow](./set_grow/)(**bool**) override | Determines whether the bounds of the object should be grown as a result of the blurring. True indicates the bounds are grown while false indicates that they are not. Write **bool**. |
| void [set_Radius](./set_radius/)(**double**) override | Sets blur radius. Write **double**. |
