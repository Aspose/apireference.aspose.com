...
type: docs
weight: 924
url: /cpp/aspose.slides.effects/isoftedge/
---
## ISoftEdge class
...
```cpp
class ISoftEdge : public virtual Aspose::Slides::Effects::IImageTransformOperation,                  public Aspose::Slides::IAccessiblePVIObject<System::SharedPtr<Aspose::Slides::Effects::ISoftEdgeEffectiveData>>
```
...
| virtual **double** [get_Radius](./get_radius/)() | Specifies the radius of blur to apply to the edges. Read **double**. |
...
| virtual void [set_Radius](./set_radius/)(**double**) | Specifies the radius of blur to apply to the edges. Write **double**. |
