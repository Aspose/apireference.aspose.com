...
type: docs
weight: 1041
url: /cpp/aspose.slides.effects/softedge/
---
## SoftEdge class
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determines whether the specified [SoftEdge](./) is equal to the current [SoftEdge](./). |
...
| **double** [get_Radius](./get_radius/)() override | Specifies the radius of blur to apply to the edges. Read **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdgeEffectiveData](../isoftedgeeffectivedata/)\> [GetEffective](./geteffective/)() override | Gets effective Soft Edge effect data with the inheritance applied. |
...
| void [set_Radius](./set_radius/)(**double**) override | Specifies the radius of blur to apply to the edges. Write **double**. |
