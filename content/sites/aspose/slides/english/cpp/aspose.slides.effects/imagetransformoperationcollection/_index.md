...
type: docs
weight: 807
url: /cpp/aspose.slides.effects/imagetransformoperationcollection/
---
...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\&) override | Adds the new image effect to the end of a collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaBiLevel](../ialphabilevel/)\> [AddAlphaBiLevelEffect](./addalphabileveleffect/)(**float**) override | Adds the new Alpha Bi-Level effect to the end of a collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaCeiling](../ialphaceiling/)\> [AddAlphaCeilingEffect](./addalphaceilingeffect/)() override | Adds the new Alpha Ceiling effect to the end of a collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaFloor](../ialphafloor/)\> [AddAlphaFloorEffect](./addalphaflooreffect/)() override | Adds the new Alpha Floor effect to the end of a collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaInverse](../ialphainverse/)\> [AddAlphaInverseEffect](./addalphainverseeffect/)() override | Adds the new Alpha Inverse effect to the end of a collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulate](../ialphamodulate/)\> [AddAlphaModulateEffect](./addalphamodulateeffect/)() override | Adds the new Alpha Modulate effect to the end of a collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixed](../ialphamodulatefixed/)\> [AddAlphaModulateFixedEffect](./addalphamodulatefixedeffect/)(**float**) override | Adds the new Alpha Modulate Fixed effect to the end of a collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaReplace](../ialphareplace/)\> [AddAlphaReplaceEffect](./addalphareplaceeffect/)(**float**) override | Adds the new Alpha Replace effect to the end of a collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBiLevel](../ibilevel/)\> [AddBiLevelEffect](./addbileveleffect/)(**float**) override | Adds the new Bi-Level (black/white) effect to the end of a collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBlur](../iblur/)\> [AddBlurEffect](./addblureffect/)(**double**, **bool**) override | Adds the new [Blur](../blur/) effect to the end of a collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorChange](../icolorchange/)\> [AddColorChangeEffect](./addcolorchangeeffect/)() override | Adds the new Color Change effect to the end of a collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorReplace](../icolorreplace/)\> [AddColorReplaceEffect](./addcolorreplaceeffect/)() override | Adds the new Color Replacement effect to the end of a collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[IDuotone](../iduotone/)\> [AddDuotoneEffect](./addduotoneeffect/)() override | Adds the new [Duotone](../duotone/) effect to the end of a collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillOverlay](../ifilloverlay/)\> [AddFillOverlayEffect](./addfilloverlayeffect/)() override | Adds the new Fill Overlay effect to the end of a collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[IGrayScale](../igrayscale/)\> [AddGrayScaleEffect](./addgrayscaleeffect/)() override | Adds the new Gray Scale effect to the end of a collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHSL](../ihsl/)\> [AddHSLEffect](./addhsleffect/)(**float**, **float**, **float**) override | Adds the new Hue/Saturation/Luminance effect to the end of a collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILuminance](../iluminance/)\> [AddLuminanceEffect](./addluminanceeffect/)(**float**, **float**) override | Adds the new [Luminance](../luminance/) effect to the end of a collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[ITint](../itint/)\> [AddTintEffect](./addtinteffect/)(**float**, **float**) override | Adds the new [Tint](../tint/) effect to the end of a collection. |
...
| void [Clear](./clear/)() override | Removes all image effects from a collection. |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\&) const override | Determines whether the [ICollection](../../system.collections.generic/icollection/) contains a specific value. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\>, **int32_t**) override | Copies the elements of the [ICollection](../../system.collections.generic/icollection/) to an [System::Array](../../system/array/), starting at a particular [System::Array](../../system/array/) index. |
...
| **int32_t** [get_Count](./get_count/)() const override | Returns the number of image effects in a collection. Read-only **int32_t**. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Gets a value indicating whether the [ICollection](../../system.collections.generic/icollection/) is read-only. Read-only **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\>\> [GetEnumerator](./getenumerator/)() override | Returns an enumerator that iterates through the collection. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\> [idx_get](./idx_get/)(**int32_t**) override | Returns an [ImageTransformOperation](../imagetransformoperation/) from the collection by it's index. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\&) override | Removes the first occurrence of a specific object from the [ICollection](../../system.collections.generic/icollection/). |
| void [RemoveAt](./removeat/)(**int32_t**) override | Removes an image effect from a collection at the specified index. |
...
* Class [IImageTransformOperationCollection](../iimagetransformoperationcollection/)
