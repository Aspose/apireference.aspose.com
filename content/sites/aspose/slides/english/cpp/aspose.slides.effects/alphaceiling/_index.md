...
type: docs
weight: 14
url: /cpp/aspose.slides.effects/alphaceiling/
---
## AlphaCeiling class
...
```cpp
class AlphaCeiling : public Aspose::Slides::Effects::ImageTransformOperation,                     public Aspose::Slides::Effects::IAlphaCeiling,                     public Aspose::Slides::Effects::IVisualEffect
```
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determines whether the specified [AlphaCeiling](./) is equal to the current [AlphaCeiling](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaCeilingEffectiveData](../ialphaceilingeffectivedata/)\> [GetEffective](./geteffective/)() override | Gets effective Alpha Ceiling effect data with the inheritance applied. |
