...
type: docs
weight: 66
url: /cpp/aspose.slides.effects/alphamodulatefixed/
---
...
```cpp
class AlphaModulateFixed : public Aspose::Slides::Effects::ImageTransformOperation,                           public Aspose::Slides::Effects::IAlphaModulateFixed,                           public Aspose::Slides::Effects::IVisualEffect
```
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determines whether the specified [AlphaModulateFixed](./) is equal to the current [AlphaModulateFixed](./). |
...
| **float** [get_Amount](./get_amount/)() override | Returns an amount of effect in percents. Read **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixedEffectiveData](../ialphamodulatefixedeffectivedata/)\> [GetEffective](./geteffective/)() override | Gets effective Alpha Modulate Fixed effect data with the inheritance applied. |
...
| void [set_Amount](./set_amount/)(**float**) override | Returns an amount of effect in percents. Write **float**. |
