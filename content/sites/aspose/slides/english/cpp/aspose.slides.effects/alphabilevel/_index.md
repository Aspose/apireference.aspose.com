...
type: docs
weight: 1
url: /cpp/aspose.slides.effects/alphabilevel/
---
## AlphaBiLevel class
...
```cpp
class AlphaBiLevel : public Aspose::Slides::Effects::ImageTransformOperation,                     public Aspose::Slides::Effects::IAlphaBiLevel,                     public Aspose::Slides::Effects::IVisualEffect
```
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determines whether the specified [AlphaBiLevel](./) is equal to the current [AlphaBiLevel](./). |
...
| **float** [get_Threshold](./get_threshold/)() override | Returns effect threshold. Read **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Gets reference counter data structure associated with the object. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaBiLevelEffectiveData](../ialphabileveleffectivedata/)\> [GetEffective](./geteffective/)() override | Gets effective Alpha Bi-Level effect data with the inheritance applied. |
...
| void [set_Threshold](./set_threshold/)(**float**) override | Returns effect threshold. Write **float**. |
