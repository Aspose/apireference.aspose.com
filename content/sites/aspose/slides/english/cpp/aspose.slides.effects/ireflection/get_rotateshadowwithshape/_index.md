...
type: docs
weight: 287
url: /cpp/aspose.slides.effects/ireflection/get_rotateshadowwithshape/
---
## IReflection::get_RotateShadowWithShape() method


Specifies whether the reflection should rotate with the shape if the shape is rotated. Read **bool**.

```cpp
virtual bool Aspose::Slides::Effects::IReflection::get_RotateShadowWithShape()=0
```
