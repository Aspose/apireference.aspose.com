...
type: docs
weight: 131
url: /cpp/aspose.slides.effects/colorreplace/
---
## ColorReplace class
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determines whether the specified [ColorReplace](./) is equal to the current [ColorReplace](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() override | Returns color format which will replace color of every pixel. Read-only [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorReplaceEffectiveData](../icolorreplaceeffectivedata/)\> [GetEffective](./geteffective/)() override | Gets effective Color Replacement effect data with the inheritance applied. |
