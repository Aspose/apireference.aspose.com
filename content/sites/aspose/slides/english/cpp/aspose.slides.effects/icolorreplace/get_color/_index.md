...
type: docs
weight: 1
url: /cpp/aspose.slides.effects/icolorreplace/get_color/
---
## IColorReplace::get_Color() method


Returns color format which will replace color of every pixel. Read-only [IColorFormat](../../../aspose.slides/icolorformat/).

```cpp
virtual System::SharedPtr<IColorFormat> Aspose::Slides::Effects::IColorReplace::get_Color()=0
```
