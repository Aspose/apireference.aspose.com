...
description: Specifies the direction to offset the reflection. (angle). Read-only float.
type: docs
weight: 27
url: /cpp/aspose.slides.effects/ireflectioneffectivedata/get_fadedirection/
---
## IReflectionEffectiveData::get_FadeDirection() method
