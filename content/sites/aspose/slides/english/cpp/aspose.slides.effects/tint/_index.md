...
type: docs
weight: 1054
url: /cpp/aspose.slides.effects/tint/
---
## Tint class
...
```cpp
class Tint : public Aspose::Slides::Effects::ImageTransformOperation,             public Aspose::Slides::Effects::ITint,             public Aspose::Slides::Effects::IVisualEffect
```
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determines whether the specified [Tint](./) is equal to the current [Tint](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITintEffectiveData](../itinteffectivedata/)\> [GetEffective](./geteffective/)() override | Gets effective [Tint](./) effect data with the inheritance applied. |
