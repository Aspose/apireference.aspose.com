...
type: docs
weight: 1
url: /cpp/aspose.slides.charts/ilegendentrycollection/get_count/
---
## ILegendEntryCollection::get_Count method


Gets the number of elements actually contained in the collection. Read-only **int32_t**.

```cpp
virtual int32_t Aspose::Slides::Charts::ILegendEntryCollection::get_Count()=0
```
