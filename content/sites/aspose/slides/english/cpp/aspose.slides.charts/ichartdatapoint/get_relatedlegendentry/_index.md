...
type: docs
weight: 196
url: /cpp/aspose.slides.charts/ichartdatapoint/get_relatedlegendentry/
---
## IChartDataPoint::get_RelatedLegendEntry() method
...
```cpp
virtual System::SharedPtr<ILegendEntryProperties> Aspose::Slides::Charts::IChartDataPoint::get_RelatedLegendEntry()=0
```
