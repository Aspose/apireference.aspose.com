...
type: docs
weight: 66
url: /cpp/aspose.slides.charts/ichartdatapoint/get_colorvalue/
---
## IChartDataPoint::get_ColorValue method


Returns the color value of chart data point. Used with Map charts. Read-only [IDoubleChartValue](../../idoublechartvalue/).

```cpp
virtual System::SharedPtr<IDoubleChartValue> Aspose::Slides::Charts::IChartDataPoint::get_ColorValue()=0
```
