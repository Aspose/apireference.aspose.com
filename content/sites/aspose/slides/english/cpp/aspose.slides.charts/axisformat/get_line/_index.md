...
type: docs
weight: 14
url: /cpp/aspose.slides.charts/axisformat/get_line/
---
## AxisFormat::get_Line() method


Returns line style properties of an axis. Read-only [ILineFormat](../../../aspose.slides/ilineformat/).

```cpp
System::SharedPtr<ILineFormat> Aspose::Slides::Charts::AxisFormat::get_Line() override
```
