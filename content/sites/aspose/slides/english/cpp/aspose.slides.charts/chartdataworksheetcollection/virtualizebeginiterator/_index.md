...
type: docs
weight: 131
url: /cpp/aspose.slides.charts/chartdataworksheetcollection/virtualizebeginiterator/
---
## ChartDataWorksheetCollection::virtualizeBeginIterator() method


Gets iterator pointing to the first element (if any) of the collection.

```cpp
virtualized_iterator * Aspose::Slides::Charts::ChartDataWorksheetCollection::virtualizeBeginIterator() override
```
