...
type: docs
weight: 1210
url: /cpp/aspose.slides.charts/istringordoublechartvalue/
---
...
| virtual **double** [get_AsLiteralDouble](./get_asliteraldouble/)() | Returns the literal double if DataSourceType property is [DataSourceType::DoubleLiterals](../datasourcetype/). Read **double**. |
...
| virtual void [set_AsLiteralDouble](./set_asliteraldouble/)(**double**) | Sets the literal double if DataSourceType property is [DataSourceType::DoubleLiterals](../datasourcetype/). Write **double**. |
...
| virtual **double** [ToDouble](./todouble/)() | Converts value to double. |
