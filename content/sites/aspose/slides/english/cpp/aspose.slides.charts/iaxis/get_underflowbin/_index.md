...
type: docs
weight: 1223
url: /cpp/aspose.slides.charts/iaxis/get_underflowbin/
---
## IAxis::get_UnderflowBin() method
...
```cpp
virtual double Aspose::Slides::Charts::IAxis::get_UnderflowBin()=0
```
