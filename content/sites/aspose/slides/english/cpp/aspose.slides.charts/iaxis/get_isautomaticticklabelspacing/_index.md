...
type: docs
weight: 885
url: /cpp/aspose.slides.charts/iaxis/get_isautomaticticklabelspacing/
---
## IAxis::get_IsAutomaticTickLabelSpacing() method


Specifies automatic tick label spacing value. If false: use TickLabelSpacing property. Read **bool**.

```cpp
virtual bool Aspose::Slides::Charts::IAxis::get_IsAutomaticTickLabelSpacing()=0
```
