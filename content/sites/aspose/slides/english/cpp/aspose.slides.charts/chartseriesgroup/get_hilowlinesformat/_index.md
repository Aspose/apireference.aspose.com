...
type: docs
weight: 339
url: /cpp/aspose.slides.charts/chartseriesgroup/get_hilowlinesformat/
---
## ChartSeriesGroup::get_HiLowLinesFormat method
...
```cpp
System::SharedPtr<IChartLinesFormat> Aspose::Slides::Charts::ChartSeriesGroup::get_HiLowLinesFormat() override
```
