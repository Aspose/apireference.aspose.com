...
---
## ChartSeriesGroup::set_BubbleSizeRepresentation method
...
```cpp
void Aspose::Slides::Charts::ChartSeriesGroup::set_BubbleSizeRepresentation(BubbleSizeRepresentationType value) override
```
