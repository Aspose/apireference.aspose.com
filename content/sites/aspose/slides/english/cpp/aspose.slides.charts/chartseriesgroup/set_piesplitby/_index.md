...
type: docs
weight: 274
url: /cpp/aspose.slides.charts/chartseriesgroup/set_piesplitby/
---
## ChartSeriesGroup::set_PieSplitBy(PieSplitType) method
...
```cpp
void Aspose::Slides::Charts::ChartSeriesGroup::set_PieSplitBy(PieSplitType value) override
```
