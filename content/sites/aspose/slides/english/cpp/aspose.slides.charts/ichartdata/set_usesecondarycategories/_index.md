...
description: "If set to false then IChartData::get_SecondaryCategories returns null and data in IChartData::get_Categories is used both for primary and secondary series. If set to true then data in IChartData::get_SecondaryCategories is used for secondary series and data in IChartData::get_Categories is used for primary series. Write bool."
type: docs
weight: 66
url: /cpp/aspose.slides.charts/ichartdata/set_usesecondarycategories/
---
## IChartData::set_UseSecondaryCategories method
