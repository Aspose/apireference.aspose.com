...
description: Represents collection of IChartSeries
type: docs
weight: 833
url: /cpp/aspose.slides.charts/ichartseriescollection/
---
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) | Creates new chart series and adds it to the collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) | Creates new chart series from [IChartDataCell](../ichartdatacell/) and adds it to the collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) | Creates new chart series from [IChartCellCollection](../ichartcellcollection/) and adds it to the collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) | Creates new chart series from value and adds it to the collection. |
...
| virtual void [Clear](./clear/)() | Removes all elements (including the chart style) from the collection. |
