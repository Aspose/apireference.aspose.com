...
type: docs
weight: 131
url: /cpp/aspose.slides.charts/irotation3d/get_heightpercents/
---
## IRotation3D::get_HeightPercents method


Specifies the height of a 3-D chart as a percentage of the chart width (between 5 and 500 percent). Read **uint16_t**.

```cpp
virtual uint16_t Aspose::Slides::Charts::IRotation3D::get_HeightPercents()=0
```
