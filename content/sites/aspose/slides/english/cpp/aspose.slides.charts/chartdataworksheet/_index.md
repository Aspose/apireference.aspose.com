...
description: Represents worksheet associated with IChartDataCell
type: docs
weight: 209
url: /cpp/aspose.slides.charts/chartdataworksheet/
---
...
| **int32_t** [get_Index](./get_index/)() override | Gets the index of the worksheet. Read-only **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Returns the name of the worksheet. Read-only [System::String](../../system/string/). |
