...
type: docs
weight: 287
url: /cpp/aspose.slides.charts/chartcategorycollection/settemplateweakptr/
---
## ChartCategoryCollection::SetTemplateWeakPtr(uint32_t) method


Set n'th template argument a weak pointer (rather than shared). Allows switching pointers in containers to weak mode.

```cpp
void Aspose::Slides::Charts::ChartCategoryCollection::SetTemplateWeakPtr(uint32_t argument) override
```
