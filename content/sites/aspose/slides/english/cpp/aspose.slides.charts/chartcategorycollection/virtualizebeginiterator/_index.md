...
type: docs
weight: 235
url: /cpp/aspose.slides.charts/chartcategorycollection/virtualizebeginiterator/
---
## ChartCategoryCollection::virtualizeBeginIterator method


Gets iterator pointing to the first element (if any) of the collection.

```cpp
virtualized_iterator * Aspose::Slides::Charts::ChartCategoryCollection::virtualizeBeginIterator() override
```
