...
type: docs
weight: 27
url: /cpp/aspose.slides.charts/iactuallayout/get_actualwidth/
---
## IActualLayout::get_ActualWidth method
...
```cpp
virtual float Aspose::Slides::Charts::IActualLayout::get_ActualWidth()=0
```
