...
type: docs
weight: 326
url: /cpp/aspose.slides.charts/chartdatapoint/get_actualheight/
---
## ChartDataPoint::get_ActualHeight() method
...
```cpp
float Aspose::Slides::Charts::ChartDataPoint::get_ActualHeight() override
```
