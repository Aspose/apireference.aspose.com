...
| [ChartCategoryCollection](./chartcategorycollection/) | Represents collection of [ChartCategory](./chartcategory/) |
...
| [ChartSeriesCollection](./chartseriescollection/) | Represents collection of [ChartSeries](./chartseries/) |
...
| [ErrorBarsFormat](./errorbarsformat/) | Represents error bars of chart series. ErrorBars custom values are in [IChartDataPointCollection](./ichartdatapointcollection/) (in [IChartDataPoint::get_ErrorBarsCustomValues()](./ichartdatapoint/get_errorbarscustomvalues/) property). |
...
| [IChartCategoryCollection](./ichartcategorycollection/) | Represents collection of [IChartCategory](./ichartcategory/) |
...
| [IChartSeriesCollection](./ichartseriescollection/) | Represents collection of [IChartSeries](./ichartseries/) |
...
| [IChartSeriesReadonlyCollection](./ichartseriesreadonlycollection/) | Represents a readonly collection of [IChartSeries](./ichartseries/) |
| [IChartTextBlockFormat](./icharttextblockformat/) | Represents formatting properties for chart text elements. |
| [IChartTextFormat](./icharttextformat/) | [Chart](./chart/) operate with restricted set of text format properties. [IChartTextFormat](./icharttextformat/), [IChartTextBlockFormat](./icharttextblockformat/), [IChartParagraphFormat](./ichartparagraphformat/), [IChartPortionFormat](./ichartportionformat/) interfaces describe this restricted set. |
...
| [IErrorBarsFormat](./ierrorbarsformat/) | Represents error bars of chart series. ErrorBars custom values are in [IChartDataPointCollection](./ichartdatapointcollection/) (in [IChartDataPoint::get_ErrorBarsCustomValues()](./ichartdatapoint/get_errorbarscustomvalues/) property). |
