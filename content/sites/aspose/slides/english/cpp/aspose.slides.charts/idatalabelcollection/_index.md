...
type: docs
weight: 950
url: /cpp/aspose.slides.charts/idatalabelcollection/
---
...
| virtual **int32_t** [get_Count](./get_count/)() | Gets the number of all data labels in the collection. Read-only **int32_t**. |
| virtual **int32_t** [get_CountOfVisibleDataLabels](./get_countofvisibledatalabels/)() | Gets the number of visible data labels in the collection. Read-only **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabelFormat](../idatalabelformat/)\> [get_DefaultDataLabelFormat](./get_defaultdatalabelformat/)() | Returns default format of all data labels in the collection. Read-only [IDataLabelFormat](../idatalabelformat/). |
| virtual **bool** [get_IsVisible](./get_isvisible/)() | False means that data label is not visible by default (and so all Show*-flags (ShowValue, ...) of the DefaultDataLabelFormat property are false). Read-only **bool**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_LeaderLinesColor](./get_leaderlinescolor/)() | Gets the color of all leader lines in the collection. Read [System::Drawing::Color](../../system.drawing/color/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [get_ParentSeries](./get_parentseries/)() | Returns parent chart series. Read-only [IChartSeries](../ichartseries/). |
...
| virtual void [Hide](./hide/)() | Make data label hidden by default by setting all Show*-flags (ShowValue, ...) of the DefaultDataLabelFormat property to false state. IsVisible will be false after this. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [idx_get](./idx_get/)(**int32_t**) | Gets the data label for the data point with the specified index. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>) | Returns an index of the specified [DataLabel](../datalabel/) in the collection. |
...
| virtual void [set_LeaderLinesColor](./set_leaderlinescolor/)([System::Drawing::Color](../../system.drawing/color/)) | Sets the color of all leader lines in the collection. Write [System::Drawing::Color](../../system.drawing/color/). |
