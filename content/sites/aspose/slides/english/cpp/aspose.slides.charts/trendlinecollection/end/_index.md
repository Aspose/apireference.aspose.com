...
type: docs
weight: 79
url: /cpp/aspose.slides.charts/trendlinecollection/end/
---
## TrendlineCollection::end() method


Gets iterator pointing right after the last element (if any) of the collection.

```cpp
iterator Aspose::Slides::Charts::TrendlineCollection::end() noexcept
```
...
## TrendlineCollection::end() const method


Gets iterator pointing right after the last element (if any) of the const-qualified instance of the collection.

```cpp
const_iterator Aspose::Slides::Charts::TrendlineCollection::end() const noexcept
```
