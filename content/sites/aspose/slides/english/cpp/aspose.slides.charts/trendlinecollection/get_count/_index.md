...
type: docs
weight: 1
url: /cpp/aspose.slides.charts/trendlinecollection/get_count/
---
## TrendlineCollection::get_Count method


Gets the number of elements actually contained in the collection. Read-only **int32_t**.

```cpp
int32_t Aspose::Slides::Charts::TrendlineCollection::get_Count() override
```
