...
type: docs
weight: 131
url: /cpp/aspose.slides.charts/trendlinecollection/virtualizeenditerator/
---
## TrendlineCollection::virtualizeEndIterator method


Gets iterator pointing right after the last element (if any) of the collection.

```cpp
virtualized_iterator * Aspose::Slides::Charts::TrendlineCollection::virtualizeEndIterator() override
```
