...
type: docs
weight: 118
url: /cpp/aspose.slides.charts/trendlinecollection/virtualizebeginiterator/
---
## TrendlineCollection::virtualizeBeginIterator() method


Gets iterator pointing to the first element (if any) of the collection.

```cpp
virtualized_iterator * Aspose::Slides::Charts::TrendlineCollection::virtualizeBeginIterator() override
```
