...
type: docs
weight: 1080
url: /cpp/aspose.slides.charts/ilegend/
---
## ILegend class
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILegendEntryProperties](../ilegendentryproperties/)\> [get_Entry](./get_entry/)(**int32_t**) | Get properties of legend entry corresponding to data point in chart at the specified index. In case of chart types: bar-of-pie, exploded pie, exploded pie 3D, pie, pie 3D, pie-of-pie, data point is taken from first series. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Returns the format of a legend. Read-only [IFormat](../iformat/). |
...
| virtual **bool** [get_Overlay](./get_overlay/)() | Determines whether other chart elements shall be allowed to overlap legend. Read **bool**. |
| virtual [LegendPositionType](../legendpositiontype/) [get_Position](./get_position/)() | Specifies the position of the legend on a chart. Non-NaN values of X, Y, Width, Heigt properties override effect of this property. Read [LegendPositionType](../legendpositiontype/). |
...
| virtual void [set_Overlay](./set_overlay/)(**bool**) | Determines whether other chart elements shall be allowed to overlap legend. Write **bool**. |
| virtual void [set_Position](./set_position/)([LegendPositionType](../legendpositiontype/)) | Specifies the position of the legend on a chart. Non-NaN values of X, Y, Width, Heigt properties override effect of this property. Write [LegendPositionType](../legendpositiontype/). |
