...
type: docs
weight: 1340
url: /cpp/aspose.slides.charts/stringchartvalue/
---
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)(**int32_t**) override | Returns a chart cell at the specified index. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\> [get_AsCells](./get_ascells/)() override | Null value assigning is not allowed. Returning value always is not null. Read [IChartCellCollection](../ichartcellcollection/). |
...
| [System::String](../../system/string/) [GetCellsAddressInWorkbook](./getcellsaddressinworkbook/)() override | If DataSourceType property is [DataSourceType::Worksheet](../datasourcetype/) then this method returns address of the cells in workbook which represent the string data. Otherwise return empty string. |
...
| void [set_AsCells](./set_ascells/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>) override | Null value assigning is not allowed. Returning value always is not null. Write [IChartCellCollection](../ichartcellcollection/). |
...
| void [SetFromOneCell](./setfromonecell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | Sets value from specified cell. |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | Returns string value data. Return null if DataSourceType is false and no string value was assigned. |
