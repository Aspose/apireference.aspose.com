...
type: docs
weight: 170
url: /cpp/aspose.slides.charts/chartdatapointlevel/
---
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Represents formatting properties of data point level. Read [IFormat](../iformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() override | Represents data label of data point level. Applied for Treemap and Sunburst sereis types. Read-only [IDataLabel](../idatalabel/). |
