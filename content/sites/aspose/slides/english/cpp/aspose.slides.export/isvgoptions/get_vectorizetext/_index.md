...
type: docs
weight: 1
url: /cpp/aspose.slides.export/isvgoptions/get_vectorizetext/
---
## ISVGOptions::get_VectorizeText method


Determines whether the text on a slide will be saved as graphics. Read **bool**.

```cpp
virtual bool Aspose::Slides::Export::ISVGOptions::get_VectorizeText()=0
```
