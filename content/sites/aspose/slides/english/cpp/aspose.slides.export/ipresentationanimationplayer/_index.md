...
type: docs
weight: 287
url: /cpp/aspose.slides.export/ipresentationanimationplayer/
---
...
```cpp
class IPresentationAnimationPlayer : public virtual System::Object
```
...
| virtual ASPOSE_SLIDES_LOCAL_API void [SetTimePosition](./settimeposition/)(**double**) | Set the animation time position within the [IPresentationAnimationPlayer::get_Duration](./get_duration/). |
...
Animations generated by [PresentationAnimationsGenerator](../presentationanimationsgenerator/) via its **PresentationAnimationsGenerator::NewAnimation** event. 
