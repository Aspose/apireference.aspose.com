...
type: docs
weight: 1
url: /cpp/aspose.slides.export/ipptxoptions/get_conformance/
---
## IPptxOptions::get_Conformance() method
...
```cpp
virtual Aspose::Slides::Export::Conformance Aspose::Slides::Export::IPptxOptions::get_Conformance()=0
```
