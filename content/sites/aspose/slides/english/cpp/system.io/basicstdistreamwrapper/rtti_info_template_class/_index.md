...
---
## BasicSTDIStreamWrapper::RTTI_INFO_TEMPLATE_CLASS method


RTTI information.

```cpp
System::IO::BasicSTDIStreamWrapper<T, typename>::RTTI_INFO_TEMPLATE_CLASS(ThisType, ThisTypeBaseTypesInfo)
```
