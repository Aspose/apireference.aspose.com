...
| Method | Description |
| --- | --- |
|  [BasicSTDIOStreamWrapper](./basicstdiostreamwrapper/)(std::basic_iostream\<[char_type](./char_type/), [traits_type](./traits_type/)\>\&, [STDIOStreamWrappingMode](../stdiostreamwrappingmode/), [STDIOStreamPositionPreference](../stdiostreampositionpreference/)) | Constructs a new instance of the [BasicSTDIOStreamWrapper](./). |
|  [BasicSTDIOStreamWrapper](./basicstdiostreamwrapper/)(const [BasicSTDIOStreamWrapper](./)\&) | Copy constructor. Deleted. |
|  [BasicSTDIStreamWrapper](../basicstdistreamwrapper/basicstdistreamwrapper/)(std::basic_istream\<[char_type](../basicstdistreamwrapper/char_type/), [traits_type](../basicstdistreamwrapper/traits_type/)\>\&, [STDIOStreamWrappingMode](../stdiostreamwrappingmode/)) | Constructs a new instance of the [BasicSTDIStreamWrapper](../basicstdistreamwrapper/). |
...
|  [RTTI_INFO_TEMPLATE_CLASS](../basicstdistreamwrapper/rtti_info_template_class/)([ThisType](../basicstdistreamwrapper/thistype/), [ThisTypeBaseTypesInfo](../basicstdistreamwrapper/thistypebasetypesinfo/)) | RTTI information. |
|  [RTTI_INFO_TEMPLATE_CLASS](../stdiostreamwrapperbase/rtti_info_template_class/)([ThisType](../stdiostreamwrapperbase/thistype/), [ThisTypeBaseTypesInfo](../stdiostreamwrapperbase/thistypebasetypesinfo/)) | RTTI information. |
|  [RTTI_INFO_TEMPLATE_CLASS](../basicstdostreamwrapper/rtti_info_template_class/)([ThisType](../basicstdostreamwrapper/thistype/), [ThisTypeBaseTypesInfo](../basicstdostreamwrapper/thistypebasetypesinfo/)) | RTTI information. |
