...
type: docs
weight: 66
url: /cpp/aspose.slides.theme/formatscheme/get_presentation/
---
## FormatScheme::get_Presentation method


Returns the parent presentation. Read-only [IPresentation](../../../aspose.slides/ipresentation/).

```cpp
System::SharedPtr<IPresentation> Aspose::Slides::Theme::FormatScheme::get_Presentation() override
```
