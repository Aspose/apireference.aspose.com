...
type: docs
weight: 144
url: /cpp/aspose.slides.theme/lineformatcollection/virtualizeenditerator/
---
## LineFormatCollection::virtualizeEndIterator() method


Gets iterator pointing right after the last element (if any) of the collection.

```cpp
virtualized_iterator * Aspose::Slides::Theme::LineFormatCollection::virtualizeEndIterator() override
```
