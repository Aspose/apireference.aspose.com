...
type: docs
weight: 1
url: /cpp/aspose.slides.theme/lineformatcollection/get_count/
---
## LineFormatCollection::get_Count method


Gets the number of elements actually contained in the collection. Read-only **int32_t**.

```cpp
int32_t Aspose::Slides::Theme::LineFormatCollection::get_Count() override
```
