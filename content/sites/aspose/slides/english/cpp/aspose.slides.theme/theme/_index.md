...
type: docs
weight: 573
url: /cpp/aspose.slides.theme/theme/
---
## Theme class
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](./get_colorscheme/)() | Returns the color scheme. Read-only [IColorScheme](../icolorscheme/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontScheme](../ifontscheme/)\> [get_FontScheme](./get_fontscheme/)() | Returns the font scheme. Read-only [IFontScheme](../ifontscheme/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormatScheme](../iformatscheme/)\> [get_FormatScheme](./get_formatscheme/)() | Returns the shape format scheme. Read-only [IFormatScheme](../iformatscheme/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [GetEffective](./geteffective/)() override | Gets effective theme data with the inheritance applied. |
...
* Class [ITheme](../itheme/)
* Class [IStyleColorOwner](../../aspose.slides/istylecolorowner/)
