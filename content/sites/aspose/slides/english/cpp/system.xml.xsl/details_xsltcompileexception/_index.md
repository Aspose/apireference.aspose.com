...
description: The exception that is thrown by the Load method when an error is found in the XSLT style sheet.
type: docs
weight: 1
url: /cpp/system.xml.xsl/details_xsltcompileexception/
---
## Details_XsltCompileException class
...
| virtual **int32_t** [get_LineNumber](../details_xsltexception/get_linenumber/)() | Returns the line number indicating where the error occurred in the style sheet. |
| virtual **int32_t** [get_LinePosition](../details_xsltexception/get_lineposition/)() | Returns the line position indicating where the error occurred in the style sheet. |
| [String](../../system/string/) [get_Message](../details_xsltexception/get_message/)() const override | Returns the formatted error message describing the current exception. |
| virtual [String](../../system/string/) [get_SourceUri](../details_xsltexception/get_sourceuri/)() | Returns the location path of the style sheet. |
...
* Class [Details_XsltException](../details_xsltexception/)
