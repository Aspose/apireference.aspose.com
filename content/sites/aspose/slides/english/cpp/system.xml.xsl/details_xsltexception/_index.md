...
description: The exception that is thrown when an error occurs while processing an XSLT transformation.
type: docs
weight: 14
url: /cpp/system.xml.xsl/details_xsltexception/
---
## Details_XsltException class
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Returns the line number indicating where the error occurred in the style sheet. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Returns the line position indicating where the error occurred in the style sheet. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Returns the formatted error message describing the current exception. |
| virtual [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Returns the location path of the style sheet. |
