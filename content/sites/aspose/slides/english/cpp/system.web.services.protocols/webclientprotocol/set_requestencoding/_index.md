---
title: set_RequestEncoding
second_title: Aspose.Slides for C++ API Reference
description: Sets the encoding that is used to make the client requests.
type: docs
weight: 118
...
| --- | --- | --- |
| value | [System::SharedPtr](../../../system/sharedptr/)\<[Text::Encoding](../../../system.text/encoding/)\> | The value that must be set. |
