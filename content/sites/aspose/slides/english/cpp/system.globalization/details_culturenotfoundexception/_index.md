...
description: "CultureNotFoundException is thrown when an attempt is made to construct a culture that is not available. Never create instances of this class manually. Use the CultureNotFoundException class instead. Never wrap the CultureNotFoundException class instances into System::SmartPtr."
type: docs
weight: 92
url: /cpp/system.globalization/details_culturenotfoundexception/
---
## Details_CultureNotFoundException class


CultureNotFoundException is thrown when an attempt is made to construct a culture that is not available. Never create instances of this class manually. Use the CultureNotFoundException class instead. Never wrap the CultureNotFoundException class instances into [System::SmartPtr](../../system/smartptr/).
