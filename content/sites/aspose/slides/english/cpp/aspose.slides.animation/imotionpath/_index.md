...
type: docs
weight: 300
url: /cpp/aspose.slides.animation/imotionpath/
---
## IMotionPath class
...
| virtual void [Clear](./clear/)() | Removes all commands from the collection. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Returns the number of paths in the collection. Read-only **int32_t**. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMotionCmdPath](../imotioncmdpath/)\>) | Removes specified commans from the collection. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Removes a command at the specified index. |
