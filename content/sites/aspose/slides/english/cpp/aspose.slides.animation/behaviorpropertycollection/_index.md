...
type: docs
weight: 66
url: /cpp/aspose.slides.animation/behaviorpropertycollection/
---
...
| **int32_t** [get_Count](./get_count/)() const override | Returns the number of properties stored in the collection. Read-only **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\>\> [GetEnumerator](./getenumerator/)() override | Returns an enumerator that iterates through the collection. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\> [idx_get](./idx_get/)(**int32_t**) const override | Returns a property at the specified index. |
| virtual T [idx_get](../../system.collections.generic/ilist/idx_get/)(int) const | Gets element at specified index. |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>) override | Returns a property at the specified index. |
| virtual void [idx_set](../../system.collections.generic/ilist/idx_set/)(int, T) | Sets element at specified index. |
| **int32_t** [IndexOf](./indexof/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) const override | Determines the index of a specific item in the [IList](../../system.collections.generic/ilist/). |
| **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const override | Determines the index of a specific item by property value in the [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Inserts a new property to the collection at the specified index. |
| void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) override | Inserts a new property (with the specified property value) to the collection at the specified index. |
