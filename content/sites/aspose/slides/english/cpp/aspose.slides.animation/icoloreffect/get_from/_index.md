...
type: docs
weight: 1
url: /cpp/aspose.slides.animation/icoloreffect/get_from/
---
## IColorEffect::get_From() method


This value is used to specify the starting color of behavior. Read [IColorFormat](../../../aspose.slides/icolorformat/).

```cpp
virtual System::SharedPtr<IColorFormat> Aspose::Slides::Animation::IColorEffect::get_From()=0
```
