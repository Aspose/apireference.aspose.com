...
type: docs
weight: 131
url: /cpp/aspose.slides.animation/pointcollection/virtualizebeginconstiterator/
---
## PointCollection::virtualizeBeginConstIterator() const method


Gets iterator pointing to the first element (if any)of the const-qualified instance of the collection.

```cpp
virtualized_iterator * Aspose::Slides::Animation::PointCollection::virtualizeBeginConstIterator() const override
```
