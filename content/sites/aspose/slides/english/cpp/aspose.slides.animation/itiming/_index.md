...
type: docs
weight: 443
url: /cpp/aspose.slides.animation/itiming/
---
## ITiming class
...
| virtual **float** [get_Accelerate](./get_accelerate/)() | Describes the percentage of duration accelerate behavior effect. Read **float**. |
| virtual **bool** [get_AutoReverse](./get_autoreverse/)() | Describes whether to automatically play the animation in reverse after playing it in the forward direction. Read **bool**. |
| virtual **float** [get_Decelerate](./get_decelerate/)() | Describes the percentage of duration decelerate behavior effect. Read **float**. |
| virtual **float** [get_Duration](./get_duration/)() | Describes the duration of animation effect. Read **float**. |
| virtual **float** [get_RepeatCount](./get_repeatcount/)() | Describes the number of times the effect should repeat. Read **float**. |
| virtual **float** [get_RepeatDuration](./get_repeatduration/)() | Describes the number of times the effect should repeat. Read **float**. |
...
| virtual void [set_Accelerate](./set_accelerate/)(**float**) | Describes the percentage of duration accelerate behavior effect. Write **float**. |
| virtual void [set_AutoReverse](./set_autoreverse/)(**bool**) | Describes whether to automatically play the animation in reverse after playing it in the forward direction. Write **bool**. |
| virtual void [set_Decelerate](./set_decelerate/)(**float**) | Describes the percentage of duration decelerate behavior effect. Write **float**. |
| virtual void [set_Duration](./set_duration/)(**float**) | Describes the duration of animation effect. Write **float**. |
| virtual void [set_RepeatCount](./set_repeatcount/)(**float**) | Describes the number of times the effect should repeat. Write **float**. |
| virtual void [set_RepeatDuration](./set_repeatduration/)(**float**) | Describes the number of times the effect should repeat. Write **float**. |
