...
type: docs
weight: 105
url: /cpp/aspose.slides.animation/commandeffect/
---
## CommandEffect class
...
| [System::String](../../system/string/) [get_CommandString](./get_commandstring/)() override | Defines command string. Read [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\> [get_ShapeTarget](./get_shapetarget/)() override | Defines shape target of command effect. Read [IShape](../../aspose.slides/ishape/). |
...
| [CommandEffectType](../commandeffecttype/) [get_Type](./get_type/)() override | Defines command effect type of behavior. Read [CommandEffectType](../commandeffecttype/). |
...
| void [set_CommandString](./set_commandstring/)([System::String](../../system/string/)) override | Defines command string. Write [System::String](../../system/string/). |
| void [set_ShapeTarget](./set_shapetarget/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) override | Defines shape target of command effect. Write [IShape](../../aspose.slides/ishape/). |
...
| void [set_Type](./set_type/)([CommandEffectType](../commandeffecttype/)) override | Defines command effect type of behavior. Write [CommandEffectType](../commandeffecttype/). |
