...
type: docs
weight: 79
url: /cpp/aspose.slides.animation/iscaleeffect/get_by/
---
## IScaleEffect::get_By() method


describes the relative offset value for the animation (in percents). Read [System::Drawing::PointF](../../../system.drawing/pointf/).

```cpp
virtual System::Drawing::PointF Aspose::Slides::Animation::IScaleEffect::get_By()=0
```
