...
type: docs
weight: 482
url: /cpp/aspose.slides.animation/motionpath/
---
## MotionPath class
...
| void [Clear](./clear/)() override | Removes all commands from the collection. |
...
| **int32_t** [get_Count](./get_count/)() override | Returns the number of paths in the collection. Read-only **int32_t**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Gets reference counter data structure associated with the object. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMotionCmdPath](../imotioncmdpath/)\>\>\> [GetEnumerator](./getenumerator/)() override | Returns an enumerator that iterates through the collection. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMotionCmdPath](../imotioncmdpath/)\>) override | Removes specified commans from the collection. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Removes a command at the specified index. |
