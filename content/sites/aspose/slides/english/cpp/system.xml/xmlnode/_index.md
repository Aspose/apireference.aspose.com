...
description: Represents a single node in the XML document.
type: docs
weight: 326
...
| Method | Description |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [AppendChild](./appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>) | Adds the specified node to the end of the list of child nodes, of this node. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [Clone](./clone/)() | Creates a duplicate of this node. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [CloneNode](./clonenode/)(**bool**) | Creates a duplicate of the node, when overridden in a derived class. |
| [SharedPtr](../../system/sharedptr/)\<[XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\> [CreateNavigator](./createnavigator/)() override | Creates an XPathNavigator for navigating this object. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttributeCollection](../xmlattributecollection/)\> [get_Attributes](./get_attributes/)() | Returns an [XmlAttributeCollection](../xmlattributecollection/) containing the attributes of this node. |
| virtual [String](../../system/string/) [get_BaseURI](./get_baseuri/)() | Returns the base URI of the current node. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [get_ChildNodes](./get_childnodes/)() | Returns all the child nodes of the node. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_FirstChild](./get_firstchild/)() | Returns the first child of the node. |
| virtual **bool** [get_HasChildNodes](./get_haschildnodes/)() | Returns a value indicating whether this node has any child nodes. |
| virtual [String](../../system/string/) [get_InnerText](./get_innertext/)() | Returns the concatenated values of the node and all its child nodes. |
| virtual [String](../../system/string/) [get_InnerXml](./get_innerxml/)() | Returns the markup representing only the child nodes of this node. |
| virtual **bool** [get_IsReadOnly](./get_isreadonly/)() | Returns a value indicating whether the node is read-only. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_LastChild](./get_lastchild/)() | Returns the last child of the node. |
| virtual [String](../../system/string/) [get_LocalName](./get_localname/)() | Returns the local name of the node, when overridden in a derived class. |
| virtual [String](../../system/string/) [get_Name](./get_name/)() | Returns the qualified name of the node, when overridden in a derived class. |
| virtual [String](../../system/string/) [get_NamespaceURI](./get_namespaceuri/)() | Returns the namespace URI of this node. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_NextSibling](./get_nextsibling/)() | Returns the node immediately following this node. |
| virtual [XmlNodeType](../xmlnodetype/) [get_NodeType](./get_nodetype/)() | Returns the type of the current node, when overridden in a derived class. |
| virtual [String](../../system/string/) [get_OuterXml](./get_outerxml/)() | Returns the markup containing this node and all its child nodes. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](./get_ownerdocument/)() | Returns the [XmlDocument](../xmldocument/) to which this node belongs. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_ParentNode](./get_parentnode/)() | Returns the parent of this node (for nodes that can have parents). |
| virtual [String](../../system/string/) [get_Prefix](./get_prefix/)() | Returns the namespace prefix of this node. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_PreviousSibling](./get_previoussibling/)() | Returns the node immediately preceding this node. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_PreviousText](./get_previoustext/)() | Returns the text node that immediately precedes this node. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](./get_schemainfo/)() | Returns the post schema validation infoset that has been assigned to this node as a result of schema validation. |
| virtual [String](../../system/string/) [get_Value](./get_value/)() | Returns the value of the node. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Gets reference counter data structure associated with the object. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>\>\> [GetEnumerator](./getenumerator/)() override | Returns an enumerator that iterates through the child nodes in the current node. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog of C# [Object.GetHashCode()](../../system/object/gethashcode/) method. Enables hashing of custom objects. |
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](./getnamespaceofprefix/)([String](../../system/string/)) | Looks up the closest **xmlns** declaration for the given prefix that is in scope for the current node and returns the namespace URI in the declaration. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](./getprefixofnamespace/)([String](../../system/string/)) | Looks up the closest **xmlns** declaration for the given namespace URI that is in scope for the current node and returns the prefix defined in that declaration. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Gets actual type of object. Analog of C# [System.Object.GetType()](../../system/object/gettype/) call. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](./idx_get/)([String](../../system/string/)) | Returns the first child element with the specified [XmlNode::get_Name](./get_name/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](./idx_get/)([String](../../system/string/), [String](../../system/string/)) | Returns the first child element with the specified [XmlNode::get_LocalName](./get_localname/) and [XmlNode::get_NamespaceURI](./get_namespaceuri/) values. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [InsertAfter](./insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>) | Inserts the specified node immediately after the specified reference node. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [InsertBefore](./insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>) | Inserts the specified node immediately before the specified reference node. |
...
| virtual void [Normalize](./normalize/)() | Puts all [XmlText](../xmltext/) nodes in the full depth of the sub-tree underneath this [XmlNode](./) into a \"normal\" form where only markup (that is, tags, comments, processing instructions, CDATA sections, and entity references) separates [XmlText](../xmltext/) nodes, that is, there are no adjacent [XmlText](../xmltext/) nodes. |
|  [Object](../../system/object/object/)() | Creates object. Initializes all internal data structures. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy constructor. Doesn't copy anything, really, just initializes new object and enables copy constructing subclasses. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Assignment operator. Doesn't copy anything, really, just initializes new object and enables copy constructing subclasses. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [PrependChild](./prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>) | Adds the specified node to the beginning of the list of child nodes for this node. |
...
| virtual void [RemoveAll](./removeall/)() | Removes all the child nodes and/or attributes of the current node. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [RemoveChild](./removechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>) | Removes specified child node. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Decreases shared reference count by specified value. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [ReplaceChild](./replacechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>) | Replaces the child node **oldChild** with **newChild** node. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](./selectnodes/)(const [String](../../system/string/)\&) | Selects a list of nodes matching the [XPath](../../system.xml.xpath/) expression. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](./selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Selects a list of nodes matching the [XPath](../../system.xml.xpath/) expression. Any prefixes found in the [XPath](../../system.xml.xpath/) expression are resolved using the supplied [XmlNamespaceManager](../xmlnamespacemanager/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [SelectSingleNode](./selectsinglenode/)(const [String](../../system/string/)\&) | Selects the first [XmlNode](./) that matches the [XPath](../../system.xml.xpath/) expression. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [SelectSingleNode](./selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Selects the first [XmlNode](./) that matches the [XPath](../../system.xml.xpath/) expression. Any prefixes found in the [XPath](../../system.xml.xpath/) expression are resolved using the supplied [XmlNamespaceManager](../xmlnamespacemanager/). |
| virtual void [set_InnerText](./set_innertext/)([String](../../system/string/)) | Sets the concatenated values of the node and all its child nodes. |
| virtual void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) | Sets the markup representing only the child nodes of this node. |
| virtual void [set_Prefix](./set_prefix/)([String](../../system/string/)) | Sets the namespace prefix of this node. |
| virtual void [set_Value](./set_value/)([String](../../system/string/)) | Sets the value of the node. |
...
| virtual **bool** [Supports](./supports/)([String](../../system/string/), [String](../../system/string/)) | Tests if the DOM implementation implements a specific feature. |
...
| virtual void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Saves all the child nodes of the node to the specified [XmlWriter](../xmlwriter/), when overridden in a derived class. |
| virtual void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Saves the current node to the specified [XmlWriter](../xmlwriter/), when overridden in a derived class. |
