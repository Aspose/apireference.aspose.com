...
description: Represents a reader that provides fast, non-cached forward only access to XML data in an XmlNode.
type: docs
weight: 365
...
| Method | Description |
| --- | --- |
| void [Close](./close/)() override | Changes the [XmlNodeReader::get_ReadState](./get_readstate/) to [ReadState::Closed](../readstate/). |
...
| **bool** [get_CanReadBinaryContent](./get_canreadbinarycontent/)() override | Returns a value indicating whether the [XmlNodeReader](./) implements the binary content read methods. |
...
| **bool** [get_HasAttributes](./get_hasattributes/)() override | Returns a value indicating whether the current node has any attributes. |
| **bool** [get_HasValue](./get_hasvalue/)() override | Returns a value indicating whether the current node can have a [XmlNodeReader::get_Value](./get_value/) value. |
...
| virtual char16_t [get_QuoteChar](../xmlreader/get_quotechar/)() | When overridden in a derived class, gets the quotation mark character used to enclose the value of an attribute node. |
| [System::Xml::ReadState](../readstate/) [get_ReadState](./get_readstate/)() override | Returns the state of the reader. |
| [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](./get_schemainfo/)() override | Returns the schema information that has been assigned to the current node. |
...
|  [XmlNodeReader](./xmlnodereader/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\&) | Creates an instance of the [XmlNodeReader](./) class using the specified [XmlNode](../xmlnode/). |
