...
type: docs
weight: 1
url: /cpp/system.xml/details_xmlexception/
---
## Details_XmlException class
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Returns the line number indicating where the error occurred. Line numbers start at 1. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Returns the line position indicating where the error occurred. Line position starts at 1. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Returns a message describing the current exception. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Returns the location of the XML file. |
