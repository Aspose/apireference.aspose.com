...
type: docs
weight: 261
url: /cpp/system/details_applicationexception/
---
## Details_ApplicationException class


A base class for classes that represent application (rather than system) exceptions. Never create instances of this class manually. Use the ApplicationException class instead. Never wrap the ApplicationException class instances into [System::SmartPtr](../smartptr/).
