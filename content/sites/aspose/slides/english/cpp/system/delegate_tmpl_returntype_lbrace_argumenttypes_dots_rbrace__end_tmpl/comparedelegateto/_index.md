...
```cpp
DelegateEquality System::Delegate<ReturnType(ArgumentTypes...)>::CompareDelegateTo(const Delegate &other) const
```
...
| --- | --- | --- |
| other | const [Delegate](../delegate/)\& | Delegate to compare the current one with. |
