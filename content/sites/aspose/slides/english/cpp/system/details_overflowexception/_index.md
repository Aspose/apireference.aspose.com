...
type: docs
weight: 599
url: /cpp/system/details_overflowexception/
---
## Details_OverflowException class


OverflowException is thrown when an operation results in an overflow. Never create instances of this class manually. Use the OverflowException class instead. Never wrap the OverflowException class instances into [System::SmartPtr](../smartptr/).
