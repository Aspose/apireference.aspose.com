...
description: Determines if the current object represents the date and time value that is earlier than the value represented by the specified DateTime object.
type: docs
weight: 586
url: /cpp/system/datetime/operator_less/
---
