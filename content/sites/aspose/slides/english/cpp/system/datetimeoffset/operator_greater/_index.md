...
description: Determines if the current object represents the date and time value that is later than the value represented by the specified DateTimeOffset object.
type: docs
weight: 573
url: /cpp/system/datetimeoffset/operator_greater/
---
