...
description: "Represents an exception thrown when the size of CookieContainer is greater than the MaxCookieSize property value. Never create instances of this class manually. Use the CookieException class instead. Never wrap the CookieException class instances into System::SmartPtr."
type: docs
weight: 79
url: /cpp/system.net/details_cookieexception/
---
## Details_CookieException class


Represents an exception thrown when the size of [CookieContainer](../cookiecontainer/) is greater than the MaxCookieSize property value. Never create instances of this class manually. Use the CookieException class instead. Never wrap the CookieException class instances into [System::SmartPtr](../../system/smartptr/).
...
| Method | Description |
| --- | --- |
|  [Details_CookieException](./details_cookieexception/)() | Constructs a new instance. |
|  [Details_CookieException](./details_cookieexception/)(std::nullptr_t) | Constructs a new instance. |
|  [Details_CookieException](./details_cookieexception/)([String](../../system/string/)) | Constructs a new instance. |
|  [Details_CookieException](./details_cookieexception/)([String](../../system/string/), [Exception](../../system/exception/)) | Constructs a new instance. |
...
| virtual  [~Details_CookieException](./~details_cookieexception/)() | Destructs the current instance. |
| virtual  [~Object](../../system/object/~object/)() | Destroys object. Frees all internal data structures. |
## See Also

* Class [Details_FormatException](../../system/details_formatexception/)
