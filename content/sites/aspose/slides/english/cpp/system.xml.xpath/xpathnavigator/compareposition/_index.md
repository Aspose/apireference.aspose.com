---
title: ComparePosition
second_title: Aspose.Slides for C++ API Reference
description: Compares the position of the current XPathNavigator with the position of the XPathNavigator specified.
type: docs
weight: 742
...
| --- | --- | --- |
| nav | [SharedPtr](../../../system/sharedptr/)\<[XPathNavigator](../)\> | The [XPathNavigator](../) to compare against. |
