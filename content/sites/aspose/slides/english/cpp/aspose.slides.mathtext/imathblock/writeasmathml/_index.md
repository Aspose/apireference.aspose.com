...
description: Saves content of this IMathBlock as MathML
type: docs
weight: 40
...
```cpp
virtual void Aspose::Slides::MathText::IMathBlock::WriteAsMathMl(System::SharedPtr<System::IO::Stream> stream)=0
```
