...
type: docs
weight: 105
url: /cpp/aspose.slides.mathtext/imathblock/
---
## IMathBlock class
...
| virtual void [Add](../imathelementcollection/add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Adds a math element to the end of the collection. |
...
| virtual void [Clear](../imathelementcollection/clear/)() | Removes all elements from the collection. |
| virtual **bool** [Contains](../imathelementcollection/contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Determines whether the collection contains a specific value. |
| virtual void [CopyTo](../imathelementcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>\>, **int32_t**) | Copy to specified array. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Delimit](./delimit/)(char16_t) | Delimits all child elements with separator character (without the brackets) |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](./enclose/)(char16_t, char16_t, char16_t) | Encloses child elements of this block in specified characters such as parenthesis or another as framing and delimit with a separator character. |
...
| virtual **int32_t** [get_Count](../imathelementcollection/get_count/)() | Gets the number of elements actually contained in the collection. Read-only **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [idx_get](../imathelementcollection/idx_get/)(**int32_t**) | Gets the element at the specified index. Read-only [IMathElement](../imathelement/). |
| virtual **int32_t** [IndexOf](../imathelementcollection/indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Determines the index of a specific math element in collection. |
| virtual void [Insert](../imathelementcollection/insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Inserts a math element into the collection at the specified index. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](./)\> [Join](../imathelement/join/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Joins a mathematical element and forms a mathematical block. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](./)\> [Join](../imathelement/join/)([System::String](../../system/string/)) | Joins a mathematical text and forms a mathematical block. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](./)\> [JoinBlock](./joinblock/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](./)\>) | Joins another mathematical block with this one. |
...
| virtual **bool** [Remove](../imathelementcollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Removes the first occurrence of a specific object from the collection. |
| virtual void [RemoveAt](../imathelementcollection/removeat/)(**int32_t**) | Removes the element at the specified index of the collection. |
...
| virtual void [WriteAsMathMl](./writeasmathml/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Saves content of this [IMathBlock](./) as MathML. |
