...
type: docs
weight: 703
url: /cpp/aspose.slides.mathtext/mathborderbox/
---
## MathBorderBox class
...
| **bool** [get_HideBottom](./get_hidebottom/)() override | Hide Bottom Edge (default is false) - specifies the hidden or shown state of the bottom edge of border box. |
| **bool** [get_HideLeft](./get_hideleft/)() override | Hide Left Edge (default is false) - specifies the hidden or shown state of the left edge of border box. |
| **bool** [get_HideRight](./get_hideright/)() override | Hide Right Edge (default is false) - specifies the hidden or shown state of the right edge of border box. |
| **bool** [get_HideTop](./get_hidetop/)() override | Hide Top Edge (default is false) - specifies the hidden or shown state of the top edge of border box. |
| **bool** [get_StrikethroughBottomLeftToTopRight](./get_strikethroughbottomlefttotopright/)() override | Strikethrough Bottom-Left to Top-Right (default is false). Specifies the hidden or shown state of a strikethrough diagonal line from the bottom-left corner to the top-right corner of border box. |
| **bool** [get_StrikethroughHorizontal](./get_strikethroughhorizontal/)() override | Strikethrough Horizontal (default is false) - specifies the hidden or shown state of a strikethrough horizontal line. |
| **bool** [get_StrikethroughTopLeftToBottomRight](./get_strikethroughtoplefttobottomright/)() override | Strikethrough Top-Left to Bottom-Right (default is false). Specifies the hidden or shown state of a strikethrough diagonal line from the top-left corner to the bottom-right corner of border box. |
| **bool** [get_StrikethroughVertical](./get_strikethroughvertical/)() override | Strikethrough Vertical (default is false) - specifies the hidden or shown state of a strikethrough vertical line. |
...
|  [MathBorderBox](./mathborderbox/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Creates [MathBorderBox](./) element with rectangular border. |
|  [MathBorderBox](./mathborderbox/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) | Creates [MathBorderBox](./) element. |
...
| void [set_HideBottom](./set_hidebottom/)(**bool**) override | Hide Bottom Edge (default is false) - specifies the hidden or shown state of the bottom edge of border box. |
| void [set_HideLeft](./set_hideleft/)(**bool**) override | Hide Left Edge (default is false) - specifies the hidden or shown state of the left edge of border box. |
| void [set_HideRight](./set_hideright/)(**bool**) override | Hide Right Edge (default is false) - specifies the hidden or shown state of the right edge of border box. |
| void [set_HideTop](./set_hidetop/)(**bool**) override | Hide Top Edge (default is false) - specifies the hidden or shown state of the top edge of border box. |
| void [set_StrikethroughBottomLeftToTopRight](./set_strikethroughbottomlefttotopright/)(**bool**) override | Strikethrough Bottom-Left to Top-Right (default is false). Specifies the hidden or shown state of a strikethrough diagonal line from the bottom-left corner to the top-right corner of border box. |
| void [set_StrikethroughHorizontal](./set_strikethroughhorizontal/)(**bool**) override | Strikethrough Horizontal (default is false) - specifies the hidden or shown state of a strikethrough horizontal line. |
| void [set_StrikethroughTopLeftToBottomRight](./set_strikethroughtoplefttobottomright/)(**bool**) override | Strikethrough Top-Left to Bottom-Right (default is false). Specifies the hidden or shown state of a strikethrough diagonal line from the top-left corner to the bottom-right corner of border box. |
| void [set_StrikethroughVertical](./set_strikethroughvertical/)(**bool**) override | Strikethrough Vertical (default is false) - specifies the hidden or shown state of a strikethrough vertical line. |
