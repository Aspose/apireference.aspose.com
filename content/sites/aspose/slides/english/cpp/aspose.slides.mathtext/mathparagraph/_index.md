...
type: docs
weight: 989
url: /cpp/aspose.slides.mathtext/mathparagraph/
---
## MathParagraph class
...
| Method | Description |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Adds [IMathBlock](../imathblock/) to the end of collection. |
...
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Determines whether the collection contains a specific value. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](./idx_get/)(**int32_t**) override | Gets the item at the specified index. Read-only [IMathBlock](../imathblock/). |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Gets the item at the specified index. Read-only [IMathBlock](../imathblock/). |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Determines the index of a specific [IMathBlock](../imathblock/) in collection. |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Inserts [IMathBlock](../imathblock/) into the collection at the specified index. |
...
|  [MathParagraph](./mathparagraph/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Initializes a new instance of the [MathParagraph](./) class. |
