...
type: docs
weight: 456
url: /cpp/aspose.slides.mathtext/imathparagraph/
---
...
| Method | Description |
| --- | --- |
| virtual void [Add](../imathblockcollection/add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Adds [IMathBlock](../imathblock/) to the end of collection. |
...
| virtual void [Clear](../imathblockcollection/clear/)() | Removes all elements from the collection. |
| virtual **bool** [Contains](../imathblockcollection/contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Determines whether the collection contains a specific value. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](../imathblockcollection/idx_get/)(**int32_t**) | Gets the item at the specified index. Read-only [IMathBlock](../imathblock/). |
| virtual void [idx_set](../imathblockcollection/idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Gets the item at the specified index. Read-only [IMathBlock](../imathblock/). |
| virtual **int32_t** [IndexOf](../imathblockcollection/indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Determines the index of a specific [IMathBlock](../imathblock/) in collection. |
| virtual void [Insert](../imathblockcollection/insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Inserts [IMathBlock](../imathblock/) into the collection at the specified index. |
...
* Class [IMathBlockCollection](../imathblockcollection/)
