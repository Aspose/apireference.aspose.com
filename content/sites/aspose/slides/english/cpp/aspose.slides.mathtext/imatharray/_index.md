...
type: docs
weight: 53
url: /cpp/aspose.slides.mathtext/imatharray/
---
## IMathArray class
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Argument](./get_argument/)(**int32_t**) | Returns item at the specified index of the array. Read-only [Aspose::Slides::MathText::IMathElement](../imathelement/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\> [get_Arguments](./get_arguments/)() | The set of items of the array. |
| virtual [MathVerticalAlignment](../mathverticalalignment/) [get_BaseJustification](./get_basejustification/)() | Specifies alignment of the array relative to surrounding text Text outside of the array can be aligned with the bottom, top, or center of a array object. Default value: Center. |
| virtual **bool** [get_MaximumDistribution](./get_maximumdistribution/)() | Maximum Distribution When true, the array is spaced to the maximum width of the containing element(page, column, cell, etc.). |
| virtual **bool** [get_ObjectDistribution](./get_objectdistribution/)() | Object Distribution When true, the contents of the array are spaced to the maximum width of the array object. |
| virtual **uint32_t** [get_RowSpacing](./get_rowspacing/)() | Spacing between rows of an array It is used only when RowSpacingRule is set to 3 Exactly in which case the unit of measure is points or Multiple in which case the unit of measure is half-lines. Default: 0. |
| virtual [MathRowSpacingRule](../mathrowspacingrule/) [get_RowSpacingRule](./get_rowspacingrule/)() | The type of vertical spacing between array elements. |
...
| virtual void [set_BaseJustification](./set_basejustification/)([MathVerticalAlignment](../mathverticalalignment/)) | Specifies alignment of the array relative to surrounding text Text outside of the array can be aligned with the bottom, top, or center of a array object. Default value: Center. |
| virtual void [set_MaximumDistribution](./set_maximumdistribution/)(**bool**) | Maximum Distribution When true, the array is spaced to the maximum width of the containing element(page, column, cell, etc.). |
| virtual void [set_ObjectDistribution](./set_objectdistribution/)(**bool**) | Object Distribution When true, the contents of the array are spaced to the maximum width of the array object. |
| virtual void [set_RowSpacing](./set_rowspacing/)(**uint32_t**) | Spacing between rows of an array It is used only when RowSpacingRule is set to 3 Exactly in which case the unit of measure is points or Multiple in which case the unit of measure is half-lines. Default: 0. |
| virtual void [set_RowSpacingRule](./set_rowspacingrule/)([MathRowSpacingRule](../mathrowspacingrule/)) | The type of vertical spacing between array elements. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathArray](./)\> [ToMathArray](../imathelement/tomatharray/)() | Puts in a vertical array. |
