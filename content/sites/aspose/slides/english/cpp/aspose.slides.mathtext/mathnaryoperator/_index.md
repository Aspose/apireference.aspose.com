...
type: docs
weight: 963
url: /cpp/aspose.slides.mathtext/mathnaryoperator/
---
...
```cpp
class MathNaryOperator : public Aspose::Slides::MathText::MathElementBase,                         public Aspose::Slides::MathText::IMathNaryOperator,                         public Aspose::Slides::MathText::IHasControlCharacterProperties
```
...
| **bool** [get_GrowToMatchOperandHeight](./get_growtomatchoperandheight/)() override | Operator Character grows vertically to match its operand height |
| **bool** [get_HideSubscript](./get_hidesubscript/)() override | Hide Subscript |
| **bool** [get_HideSuperscript](./get_hidesuperscript/)() override | Hide Superscript |
| [MathLimitLocations](../mathlimitlocations/) [get_LimitLocation](./get_limitlocation/)() override | The location of limits (subscript and superscript) |
| char16_t [get_Operator](./get_operator/)() override | Nary Operator Character For example: '\\u2211', '\\u222B' |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Subscript](./get_subscript/)() override | Specifies a subscript argument that, for example, in the case of an integral, sets the lower limit |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Superscript](./get_superscript/)() override | Specifies a supersript argument that, for example, in the case of an integral, sets the upper limit |
...
|  [MathNaryOperator](./mathnaryoperator/)(char16_t, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Initializes a new instance of the [MathNaryOperator](./) class. |
|  [MathNaryOperator](./mathnaryoperator/)(char16_t, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Initializes a new instance of the [MathNaryOperator](./) class. |
|  [MathNaryOperator](./mathnaryoperator/)(char16_t, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Initializes a new instance of the [MathNaryOperator](./) class. |
...
| void [set_GrowToMatchOperandHeight](./set_growtomatchoperandheight/)(**bool**) override | Operator Character grows vertically to match its operand height |
| void [set_HideSubscript](./set_hidesubscript/)(**bool**) override | Hide Subscript |
| void [set_HideSuperscript](./set_hidesuperscript/)(**bool**) override | Hide Superscript |
| void [set_LimitLocation](./set_limitlocation/)([MathLimitLocations](../mathlimitlocations/)) override | The location of limits (subscript and superscript) |
| void [set_Operator](./set_operator/)(char16_t) override | Nary Operator Character For example: '\\u2211', '\\u222B' |
