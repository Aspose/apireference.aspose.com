...
type: docs
weight: 365
url: /cpp/aspose.slides.mathtext/imathlimit/
---
## IMathLimit class
...
```cpp
class IMathLimit : public virtual Aspose::Slides::MathText::IMathElement
```
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Limit](./get_limit/)() | Limit argument. |
| virtual **bool** [get_UpperLimit](./get_upperlimit/)() | Specifies upper or lower limit. |
...
| virtual void [set_UpperLimit](./set_upperlimit/)(**bool**) | Specifies upper or lower limit. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](./)\> [SetLowerLimit](../imathelement/setlowerlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Takes lower limit. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](./)\> [SetLowerLimit](../imathelement/setlowerlimit/)([System::String](../../system/string/)) | Takes lower limit. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](./)\> [SetUpperLimit](../imathelement/setupperlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Takes upper limit. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](./)\> [SetUpperLimit](../imathelement/setupperlimit/)([System::String](../../system/string/)) | Takes upper limit. |
