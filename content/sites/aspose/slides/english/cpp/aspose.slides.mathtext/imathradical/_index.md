...
type: docs
weight: 495
url: /cpp/aspose.slides.mathtext/imathradical/
---
## IMathRadical class
...
```cpp
class IMathRadical : public virtual Aspose::Slides::MathText::IMathElement
```
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Degree](./get_degree/)() | Degree argument. |
| virtual **bool** [get_HideDegree](./get_hidedegree/)() | Hide degree When is true, the degree is not shown, as in \\u221A\\uD835\\uDC65 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](./)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Specifies the mathematical root of the given degree from the specified argument. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](./)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | Specifies the mathematical root of the given degree from the specified argument. |
...
| virtual void [set_HideDegree](./set_hidedegree/)(**bool**) | Hide degree When is true, the degree is not shown, as in \\u221A\\uD835\\uDC65 |
