...
type: docs
weight: 937
url: /cpp/aspose.slides.mathtext/mathmatrix/
---
## MathMatrix class
...
| void [DeleteColumn](./deletecolumn/)(**int32_t**) override | Deletes the specified column. |
| void [DeleteRow](./deleterow/)(**int32_t**) override | Deletes the specified row. |
...
| [MathVerticalAlignment](../mathverticalalignment/) [get_BaseJustification](./get_basejustification/)() override | Specifies the vertical justification respect to surrounding text. Possible values are top, bottom, and center. Default: Center. |
| **int32_t** [get_ColumnCount](./get_columncount/)() override | Number of columns in the matrix. |
| **uint32_t** [get_ColumnGap](./get_columngap/)() override | The value of horizontal spacing between columns of a matrix; If the ColumnGapRule is set to 3 (\"Exactly\"), then the unit is interpreted as twips (1/20th of a point) If the ColumnGapRule is set to 4 (\"Multiple\"), then the unit is interpreted as number of 0.5 em increments. In other cases ignored. Default: 0. |
| [MathSpacingRules](../mathspacingrules/) [get_ColumnGapRule](./get_columngaprule/)() override | The type of horizontal spacing between columns of a matrix; Horizontal spacing units can be ems or points (stored as twips). Default: SingleSpacingGap (0) |
| **bool** [get_HidePlaceholders](./get_hideplaceholders/)() override | Hide the placeholders for empty matrix elements Default: false. |
| **uint32_t** [get_MinColumnWidth](./get_mincolumnwidth/)() override | Minimum column width in twips (1/20th of a point) The gap spacing (also referred to as \\u201CColumn Gap\\u201D or \\u201CGap Width\\u201D) is added to the MinColumnWidth to determine the total Matrix [Column](../../aspose.slides/column/) Spacing (distance between the same edges of different columns). Default: 0. |
| **int32_t** [get_RowCount](./get_rowcount/)() override | Number of rows in the matrix. |
| **uint32_t** [get_RowGap](./get_rowgap/)() override | The value of vertical spacing between rows of a matrix; If the RowGapRule is set to 3 (\"Exactly\"), then the unit is interpreted as twips (1/20th of a point) If the RowGapRule is set to 4 (\"Multiple\"), then the unit is interpreted as half-lines. Default: 0. |
| [MathSpacingRules](../mathspacingrules/) [get_RowGapRule](./get_rowgaprule/)() override | The type of vertical spacing between rows of a matrix; Vertical spacing units can be lines or points (stored as twips). Default: SingleSpacingGap (0) |
...
| [MathHorizontalAlignment](../mathhorizontalalignment/) [GetColumnAlignment](./getcolumnalignment/)(**int32_t**) override | Get the horizontal alignment of the specified column. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [idx_get](./idx_get/)(**int32_t**, **int32_t**) override | Element of matrix. |
| void [idx_set](./idx_set/)(**int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Element of matrix. |
| void [InsertColumnAfter](./insertcolumnafter/)(**int32_t**) override | Insert a new column after the specified one Initially all elements in the new column are null. |
| void [InsertColumnBefore](./insertcolumnbefore/)(**int32_t**) override | Insert a new column before the specified one Initially all elements in the new column are null. |
| void [InsertRowAfter](./insertrowafter/)(**int32_t**) override | Insert a new row after the specified one Initially all elements in the new row are null. |
| void [InsertRowBefore](./insertrowbefore/)(**int32_t**) override | Insert a new row before the specified one Initially all elements in the new row are null. |
...
|  [MathMatrix](./mathmatrix/)(**int32_t**, **int32_t**) | Initializes a new instance of the [MathMatrix](./) class. |
...
| void [set_BaseJustification](./set_basejustification/)([MathVerticalAlignment](../mathverticalalignment/)) override | Specifies the vertical justification respect to surrounding text. Possible values are top, bottom, and center. Default: Center. |
| void [set_ColumnGap](./set_columngap/)(**uint32_t**) override | The value of horizontal spacing between columns of a matrix; If the ColumnGapRule is set to 3 (\"Exactly\"), then the unit is interpreted as twips (1/20th of a point) If the ColumnGapRule is set to 4 (\"Multiple\"), then the unit is interpreted as number of 0.5 em increments. In other cases ignored. Default: 0. |
| void [set_ColumnGapRule](./set_columngaprule/)([MathSpacingRules](../mathspacingrules/)) override | The type of horizontal spacing between columns of a matrix; Horizontal spacing units can be ems or points (stored as twips). Default: SingleSpacingGap (0) |
| void [set_HidePlaceholders](./set_hideplaceholders/)(**bool**) override | Hide the placeholders for empty matrix elements Default: false. |
| void [set_MinColumnWidth](./set_mincolumnwidth/)(**uint32_t**) override | Minimum column width in twips (1/20th of a point) The gap spacing (also referred to as \\u201CColumn Gap\\u201D or \\u201CGap Width\\u201D) is added to the MinColumnWidth to determine the total Matrix [Column](../../aspose.slides/column/) Spacing (distance between the same edges of different columns). Default: 0. |
| void [set_RowGap](./set_rowgap/)(**uint32_t**) override | The value of vertical spacing between rows of a matrix; If the RowGapRule is set to 3 (\"Exactly\"), then the unit is interpreted as twips (1/20th of a point) If the RowGapRule is set to 4 (\"Multiple\"), then the unit is interpreted as half-lines. Default: 0. |
| void [set_RowGapRule](./set_rowgaprule/)([MathSpacingRules](../mathspacingrules/)) override | The type of vertical spacing between rows of a matrix; Vertical spacing units can be lines or points (stored as twips). Default: SingleSpacingGap (0) |
| void [SetColumnAlignment](./setcolumnalignment/)(**int32_t**, [MathHorizontalAlignment](../mathhorizontalalignment/)) override | Set the horizontal alignment of the specified column. |
| void [SetColumnsAlignment](./setcolumnsalignment/)(**int32_t**, **uint32_t**, [MathHorizontalAlignment](../mathhorizontalalignment/)) override | Set the horizontal alignment of the specified columns. |
