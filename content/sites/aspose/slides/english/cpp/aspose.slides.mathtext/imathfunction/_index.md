...
type: docs
weight: 300
url: /cpp/aspose.slides.mathtext/imathfunction/
---
## IMathFunction class
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](./)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Takes specified function using this instance as the argument. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](./)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([System::String](../../system/string/)) | Takes specified function using this instance as the argument. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](./)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfOneArgument](../mathfunctionsofoneargument/)) | Takes specified function using this instance as the argument. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](./)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) | Takes specified function using this instance as the argument and specified additional argument. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](./)\> [Function](../imathelement/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Takes a function of an argument using this instance as the function name. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](./)\> [Function](../imathelement/function/)([System::String](../../system/string/)) | Takes a function of an argument using this instance as the function name. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() | Function Argument. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Name](./get_name/)() | Function name For example, function names are sin and cos. |
