...
| [AutoShapeLock](../../aspose.slides/autoshape/autoshapelock) { get; } | Returns autoshape's locks. Read-only [`IAutoShapeLock`](../iautoshapelock). |
...
| [IsTextBox](../../aspose.slides/autoshape/istextbox) { get; } | Specifies if the shape is a text box. |
...
| [ShapeLock](../../aspose.slides/autoshape/shapelock) { get; } | Returns shape's locks. Read-only [`IAutoShapeLock`](../iautoshapelock). (2 properties) |
...
| [TextFrame](../../aspose.slides/autoshape/textframe) { get; } | Returns TextFrame object for the AutoShape. Read-only [`ITextFrame`](../itextframe). |
...
| [UseBackgroundFill](../../aspose.slides/autoshape/usebackgroundfill) { get; set; } | Determines whether this autoshape should be filled with slide's background fill instead of specified by style or fill format. Read/write Boolean. |
