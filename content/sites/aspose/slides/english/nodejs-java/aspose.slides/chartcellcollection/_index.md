...
url: /nodejs-java/aspose.slides/chartcellcollection/
---
...
| [getCount](getcount)() | Gets the count of cells in collection. Read-only int. |
| [get_Item](get_item)(int) | Returns a cell (IChartDataCell) by index. |
