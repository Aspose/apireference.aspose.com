...
url: /nodejs-java/aspose.slides/textanimation/
---
...
| Name | Description |
| --- | --- |
| [addEffect](addeffect)(int, int, int) | Add new effect to the end of current sequence to end of group text animations. Only valid if count of text paragraphs equal or greater of counts effect of this group! |
