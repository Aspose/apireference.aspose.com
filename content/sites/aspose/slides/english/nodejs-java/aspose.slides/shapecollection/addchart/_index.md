...
url: /nodejs-java/aspose.slides/shapecollection/addchart/
---

## addChart(int type, float x, float y, float width, float height)  function
...
## addChart(int type, float x, float y, float width, float height, boolean initWithSample)  function
