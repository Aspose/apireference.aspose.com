...
url: /nodejs-java/aspose.slides/shapecollection/addconnector/
---

## addConnector(int shapeType, float x, float y, float width, float height)  function
...
## addConnector(int shapeType, float x, float y, float width, float height, boolean createFromTemplate)  function
