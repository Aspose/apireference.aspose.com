...
url: /nodejs-java/aspose.slides/shapecollection/insertsummaryzoomframe/
---

## insertSummaryZoomFrame(int index, float x, float y, float width, float height)  function
