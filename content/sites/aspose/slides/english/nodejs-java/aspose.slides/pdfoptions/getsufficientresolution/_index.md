...
url: /nodejs-java/aspose.slides/pdfoptions/getsufficientresolution/
---

## getSufficientResolution()  function
 ...
 Using of similar property values may give the same result. Recommended to use step 16 or 32 to get visible effect.
