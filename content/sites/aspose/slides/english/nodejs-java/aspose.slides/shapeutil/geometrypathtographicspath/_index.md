...
url: /nodejs-java/aspose.slides/shapeutil/geometrypathtographicspath/
---
...
## geometryPathToGraphicsPath([GeometryPath](../../geometrypath) geometryPath)  function
 ...
 the  IGeometryPath to use in  GeometryShape via  #graphicsPathToGeometryPath(java.awt.Shape graphicsPath) method.
