...
url: /nodejs-java/aspose.slides/masternotesslide/
---
...
| Name | Description |
| --- | --- |
| [getHeaderFooterManager](getheaderfootermanager)() | Returns HeaderFooter manager of the master notes slide. Read-only IMasterHandoutSlideHeaderFooterManager. |
| [getNotesStyle](getnotesstyle)() | Returns the style of a notes text. Read-only ITextStyle. |
