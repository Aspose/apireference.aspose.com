...
url: /node-java/aspose.slides/sequence/addeffect/
---
...
## addEffect([PictureFrame](../../pictureframe) shape, int effectType, int subtype, int triggerType)  function
...
## addEffect([AutoShape](../../autoshape) shape, int effectType, int subtype, int triggerType)  function
...
## addEffect([ZoomFrame](../../zoomframe) shape, int effectType, int subtype, int triggerType)  function
...
## addEffect([Shape](../../shape) shape, int effectType, int subtype, int triggerType)  function
...
## addEffect([Paragraph](../../paragraph) paragraph, int effectType, int subtype, int triggerType)  function
...
## addEffect([Chart](../../chart) chart, int type, int index, int effectType, int subtype, int triggerType)  function
...
## addEffect([Chart](../../chart) chart, int type, int seriesIndex, int categoriesIndex, int effectType, int subtype, int triggerType)  function
