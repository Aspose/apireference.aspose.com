...
description: Examples contain add bidi marks, use tab character per level for list indentation and use space character per level for list indentation
type: docs
weight: 1700
url: /words/net/programming-with-txtsaveoptions/
---
Examples contain add bidi marks, use tab character per level for list indentation and use space character per level for list indentation
