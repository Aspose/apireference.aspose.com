...
Gets the hyperlink address. Must be set if the value of the [.isHyperlink](../../null/\#isHyperlink) property is true.
...
Sets the hyperlink address. Must be set if the value of the [.isHyperlink](../../null/\#isHyperlink) property is true.
